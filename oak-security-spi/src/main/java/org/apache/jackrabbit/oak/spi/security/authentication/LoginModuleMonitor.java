...
public interface LoginModuleMonitor extends Monitor<LoginModuleMonitor> {
    ...
    /**
     * Event to be called in the case there is an error in the login chain. This is not covering
     * failed logins, but actual operational errors that probably need to be investigated. Any
    ...
    /**
     * Marks a failed login attempt for the given {@link Credentials} that resulted in the given
     * {@link javax.jcr.LoginException}.
     *
     ...
     */
    default void loginFailed(@NotNull LoginException loginException,
        @Nullable Credentials credentials) {
    }

    /**
     * Record the time taken to collect the given number of principals during the commit phase of a
     * given {@code LoginModule}.
     *
