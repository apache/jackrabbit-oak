...
/**
 * The {@link RepositoryPermission} allows to evaluate permissions that have been defined on the
 * repository level and which consequently are not bound to a particular item.
 *
...
public interface RepositoryPermission {
    ...
    /**
     * Returns {@code true} if the specified repository level permissions are {@code granted}; false
     * otherwise.
     *
     * @param repositoryPermissions Any valid repository level permission such as for example:
     *                              <ul>
     ...
     *                              </ul>
     * @return {@code true} if the specified repository level permissions are {@code granted};
