...
/**
 * Interface to manage the supported restrictions present with a given access control and permission
...
public interface RestrictionProvider {
    ...
    /**
     * Returns the restriction definitions supported by this provider implementation at the
     * specified path.
     *
     * @param oakPath The path of the access controlled tree. A {@code null} path indicates that the
     *                supported restrictions for repository level policies should be returned.
     ...
     * @throws AccessControlException If no matching restriction definition exists for the specified
     *                                parameters.
     ...
     * @param oakPath The path of the access controlled tree or {@code null} if the target policies
     *                applies to the repository level.
     * @param aceTree The tree corresponding to an ACE that may contain restrictions.
     * @return The valid restrictions stored with the specified tree or an empty set.
     */
    @NotNull
    Set<Restriction> readRestrictions(@Nullable String oakPath, @NotNull Tree aceTree);

    /**
     * Writes the given restrictions to the specified ACE tree. Note, that this method does not need
     * to validate the specified restrictions (see also
     * {@link #validateRestrictions(String, org.apache.jackrabbit.oak.api.Tree)}).
     *
     * @param oakPath      The path of the access controlled tree or {@code null} if the target
     *                     policies applies to the repository level.
     * @param aceTree      The tree corresponding to an ACE that will have the specified
     *                     restrictions added.
     * @param restrictions The set of restrictions to be written to the specified tree.
     * @throws RepositoryException If an error occurs while writing the restrictions.
     */
    void writeRestrictions(@Nullable String oakPath, @NotNull Tree aceTree,
    ...
    /**
     * Creates the {@link RestrictionPattern} for the restriction information stored with specified
     * tree.
     *
     * @param oakPath The path of the access controlled tree or {@code null} if the target policies
     *                applies to the repository level.
     * @param tree    The tree holding the restriction information.
     * @return A new {@link RestrictionPattern} representing the restriction information present
     * with the given tree.
     */
    @NotNull
    ...
    /**
     * Creates the {@link RestrictionPattern} for the specified restrictions. The implementation
     * should ignore all restrictions present in the specified set that it doesn't support.
     *
     * @param oakPath      The path of the access controlled tree or {@code null} if the target
     *                     policies applies to the repository level.
     * @param restrictions the restrictions.
     * @return A new {@link RestrictionPattern} representing those restrictions of the specified set
    ...
    RestrictionProvider EMPTY = new RestrictionProvider() {
        ...
        public Restriction createRestriction(@Nullable String oakPath, @NotNull String oakName,
            ...
            throw new AccessControlException(
                "This implementation doesn't support any restrictions");
        }
