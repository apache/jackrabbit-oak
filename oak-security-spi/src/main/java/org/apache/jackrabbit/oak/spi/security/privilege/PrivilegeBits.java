...
public final class PrivilegeBits implements PrivilegeConstants {
    ...
    private static final long INSECURE_QUERY_OPTIONS = INDEX_DEFINITION_MNGMT << 1;
    ...
    static {
        ...
        privs.put(REP_INSECURE_QUERY_OPTIONS, getInstance(INSECURE_QUERY_OPTIONS));
        ...
        bits.put(INSECURE_QUERY_OPTIONS, REP_INSECURE_QUERY_OPTIONS);
    ...
    public static final PrivilegeBits NEXT_AFTER_BUILT_INS = getInstance(INSECURE_QUERY_OPTIONS).nextBits();
    ...
    private static long calculateOtherPermissions(long privs) {
        ...
        if ((privs & INSECURE_QUERY_OPTIONS) == INSECURE_QUERY_OPTIONS) {
            perm |= Permissions.INSECURE_QUERY_OPTIONS;
        }
        return perm;
    }
