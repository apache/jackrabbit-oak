...
public interface SecurityConfiguration {
    ...
    /**
     * Returns the configuration parameters associated with this security configuration instance. If
     * no parameters are present {@link ConfigurationParameters#EMPTY} should be returned.
     *
    ...
    /**
     * Returns a workspace initializer for this security configuration. If this configuration
     * doesn't require any specific workspace initialization {@link WorkspaceInitializer#DEFAULT}
     * should be returned.
     *
    ...
    /**
     * Returns a repository initializer for this security configuration. If this configuration
     * doesn't require any specific repository initialization {@link RepositoryInitializer#DEFAULT}
     * should be returned.
     *
     ...
     *
     * @param workspaceName The name of the workspace.
     * @param principals    The set of principals associated with the subject that is committing
     *                      modifications.
    ...
    /**
     * Default implementation that provides empty initializers, validators, commit hooks and
     * parameters.
     */
