...
public class AbstractPrivilegeCollectionTest extends AbstractAccessControlTest {
    ...
    private @NotNull AbstractPrivilegeCollection createPrivilegeCollection(
    ...
    public void testEquals() {
        ...
        assertEquals(apc, createPrivilegeCollection(REP_READ_PROPERTIES, REP_READ_NODES,
            JCR_READ_ACCESS_CONTROL));
        assertEquals(apc, createPrivilegeCollection(REP_READ_PROPERTIES, REP_READ_NODES, JCR_READ,
            JCR_READ_ACCESS_CONTROL));
        ...
        assertNotEquals(apc,
            createPrivilegeCollection(JCR_READ_ACCESS_CONTROL, JCR_READ, JCR_MODIFY_PROPERTIES));
        // different impl
    ...
    public void testHashCode() {
        AbstractPrivilegeCollection apc = createPrivilegeCollection(JCR_ADD_CHILD_NODES,
            JCR_MODIFY_PROPERTIES);

        assertEquals(
            getBitsProvider().getBits(JCR_ADD_CHILD_NODES, JCR_MODIFY_PROPERTIES).hashCode(),
            apc.hashCode());
        assertEquals(apc.hashCode(),
            createPrivilegeCollection(JCR_ADD_CHILD_NODES, JCR_MODIFY_PROPERTIES).hashCode());

        assertNotEquals(apc.hashCode(), createPrivilegeCollection(JCR_ADD_CHILD_NODES).hashCode());
        assertNotEquals(apc.hashCode(),
            createPrivilegeCollection(JCR_MODIFY_PROPERTIES).hashCode());
