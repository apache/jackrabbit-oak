...
public final class MongotIndexProvider implements QueryIndexProvider {

    private final MongotIndexTracker tracker;

    public MongotIndexProvider(MongotIndexTracker tracker) {
        this.tracker = tracker;
    }

    @Override
    public @NotNull List<? extends QueryIndex> getQueryIndexes(NodeState nodeState) {
        return List.of(new MongotIndex(tracker));
    }
}
