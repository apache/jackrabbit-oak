...
@Component(
        service = IndexImporterProvider.class,
        property = MongotIndexProviderService.SERVICE_PROPERTY)
public final class MongotIndexImporter implements IndexImporterProvider {

    @Override
    public void importIndex(NodeState root, NodeBuilder definitionBuilder, File indexDir)
            throws IOException, CommitFailedException {
        // Mongot data is remote and is rebuilt from repository content.
    }
