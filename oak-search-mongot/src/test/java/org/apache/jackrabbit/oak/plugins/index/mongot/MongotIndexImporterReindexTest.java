...
import org.apache.jackrabbit.oak.plugins.index.mongot.index.MongotDocumentMaker;
...
public class MongotIndexImporterReindexTest extends IndexImporterReindexTest {
    ...
    protected Tree createIndex(Tree index, String name, Set<String> propNames) {
        Tree definition = index.addChild(INDEX_DEFINITIONS_NAME).addChild(name);
        ...
        definition.setProperty(PropertyStates.createProperty(
                FulltextIndexConstants.INCLUDE_PROPERTY_NAMES, propNames, Type.STRINGS));
        return definition;
    }
    ...
    protected String getLoggerName() {
        return MongotDocumentMaker.class.getName();
    }
}
