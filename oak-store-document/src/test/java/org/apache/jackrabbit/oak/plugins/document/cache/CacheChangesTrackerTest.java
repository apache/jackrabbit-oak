...
public class CacheChangesTrackerTest {
    ...
    private NodeDocumentCache createCache() {
        ...
        CacheStatsAdapter nodeDocumentsCacheStats = Mockito.mock(CacheStatsAdapter.class);
        CacheStatsAdapter prevDocumentsCacheStats = Mockito.mock(CacheStatsAdapter.class);
