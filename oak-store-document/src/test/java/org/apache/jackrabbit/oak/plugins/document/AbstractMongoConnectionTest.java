...
/**
 * Base class for test cases that need a {@link MongoConnection} to a clean test database. Tests in subclasses are automatically skipped if the
 * configured MongoDB connection can not be created.
 */
