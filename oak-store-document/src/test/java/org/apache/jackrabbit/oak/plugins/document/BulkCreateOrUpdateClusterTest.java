    ...
    public void testSimpleConflictHandling() {
        ...
        try {
...

            {
                ...
                List<NodeDocument> resulta = ds1.createOrUpdate(Collection.NODES, Lists.new ArrayList<>(op1a, op2a, op3a));
...

            {
                ...
                List<NodeDocument> resultc = ds1.createOrUpdate(Collection.NODES, Lists.new ArrayList<>(op1c, op2c, op3c));
