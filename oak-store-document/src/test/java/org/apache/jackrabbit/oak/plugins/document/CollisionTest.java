...
public class CollisionTest {
    ...
    public void purge() throws Exception {
        ...
        String id = getIdFromPath("/", store.getSizeLimit());
    ...
    public void collisionOnOrphanedBranch() throws Exception {
        ...
        NodeDocument root = store.find(NODES, Utils.getIdFromPath(ROOT, store.getSizeLimit()));
        assertNotNull(root);
        ...
        root = store.find(NODES, Utils.getIdFromPath(ROOT, store.getSizeLimit()));
        assertNotNull(root);
        ...
        NodeDocument doc = store.find(NODES, Utils.getIdFromPath(p, store.getSizeLimit()));
        assertNotNull(doc);
