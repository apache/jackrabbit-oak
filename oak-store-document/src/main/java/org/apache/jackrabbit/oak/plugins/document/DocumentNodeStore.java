...
public final class DocumentNodeStore
    ...
    private final CacheStatsAdapter nodeCacheStats;
    ...
    private final CacheStatsAdapter nodeChildrenCacheStats;
    ...
    public CacheStatsAdapter getNodeCacheStats() {
        return nodeCacheStats;
    }

    public CacheStatsAdapter getNodeChildrenCacheStats() {
        return nodeChildrenCacheStats;
    }

    @NotNull
    public Iterable<CacheStatsAdapter> getDiffCacheStats() {
