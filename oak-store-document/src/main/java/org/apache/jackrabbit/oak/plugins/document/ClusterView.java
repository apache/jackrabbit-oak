 ...
 * instances with a backlog are in the 'inactive' bucket there).
 ...
 * already recovered) and it has no backlog anymore.
 * </ul>
 ...
 * active/deactivating/inactive for a given sequence number might change.
