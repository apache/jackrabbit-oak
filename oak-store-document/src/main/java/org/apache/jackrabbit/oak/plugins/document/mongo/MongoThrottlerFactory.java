...
public final class MongoThrottlerFactory {
    ...
    /**
     * Returns an instance of @{@link Throttler} which throttles the system exponentially based on
     * remaining threshold defined.
     *
     ...
     */
    public static Throttler exponentialThrottler(final int threshold,
        final AtomicDouble oplogWindow, final long throttlingTime) {
    ...
    private static class ExponentialThrottler implements Throttler {
        ...
        public ExponentialThrottler(final int threshold, final @NotNull AtomicDouble oplogWindow,
