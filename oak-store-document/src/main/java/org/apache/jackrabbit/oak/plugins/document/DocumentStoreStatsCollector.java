...
public interface DocumentStoreStatsCollector {
     ...
     */
    void doneFindUncached(long timeTakenNanos, Collection<? extends Document> collection,
        String key, boolean docFound, boolean isSlaveOk);
     ...
     * @param lockTime        time in millis to acquire any lock ({@code -1} if no lock was
     *                        required)
     * @param isSlaveOk       true if find was performed against a secondary instance
     */
    void doneQuery(long timeTakenNanos, Collection<? extends Document> collection, String fromKey,
        String toKey,
     ...
     */
    void doneCreate(long timeTakenNanos, Collection<? extends Document> collection,
     ...
     */
    void doneCreateOrUpdate(long timeTakenNanos, Collection<? extends Document> collection,
        List<String> ids);
     ...
     */
    void doneFindAndModify(long timeTakenNanos, Collection<? extends Document> collection,
        String key,
