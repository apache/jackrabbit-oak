...
@interface Configuration {
    ...
    @AttributeDefinition(
            ...
            description = "Boolean value indicating whether we need to avoid the exclusive merge lock while " +
                    "merging the changes in case of a conflict. The Default value is " + DEFAULT_AVOID_MERGE_LOCK +
                    " Note that this value can be overridden via framework property 'oak.documentstore.avoidMergeLock'")
