...
public class DocumentNodeStoreService {
    ...
    private void registerNodeStore() throws IOException {
        ...
        if (documentStoreType == DocumentStoreType.RDB) {
            ...
            builder.setMongoMaxIdleTimeMS(config.mongoMaxIdleTimeMillis());
            builder.setMongoMaxLifeTimeMS(config.mongoMaxLifeTimeMillis());
            builder.setMongoConnectTimeoutMS(config.mongoConnectTimeoutMillis());
            builder.setMongoHeartbeatFrequencyMS(config.mongoHeartbeatFrequencyMillis());
            builder.setMongoServerSelectionTimeoutMS(config.mongoServerSelectionTimeoutMillis());
            builder.setMongoWaitQueueTimeoutMS(config.mongoWaitQueueTimeoutMillis());
            builder.setMongoReadTimeoutMS(config.mongoReadTimeoutMillis());
            builder.setMongoMinHeartbeatFrequencyMS(config.mongoMinHeartbeatFrequencyMillis());
