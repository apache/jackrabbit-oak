...
public class DirectBinaryUploadToken {
    private String blobId;
    private Optional<String> uploadId;

    public DirectBinaryUploadToken(@Nonnull String blobId, @Nullable String uploadId) {
        this.blobId = blobId;
        this.uploadId = Optional.ofNullable(uploadId);
    }

    public static DirectBinaryUploadToken fromEncodedToken(@Nonnull String encoded) {
        ...
        return new DirectBinaryUploadToken(decodedParts[0], decodedParts.length > 2 ? decodedParts[2] : null);
    }
