 ...
 * nothing.
 * </p>
 * This class can be used when a tracker only wants to get callbacks for some of
 * the life cycle events and does not want to implement all methods specified
 * in {@link MicroKernelTracker}. This also guarantees forward compatibility when
