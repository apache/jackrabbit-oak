 ...
 * index data at {@code /var/indexing/lucene/<indexName>} and reused for all
 * queries against this version of the index. When the index data changes the
...
public class LuceneNgIndexNode {
    ...
    /**
     * Immutable snapshot of the storage node at {@code /var/indexing/lucene/<indexName>}.
     ...
     * {@code /var/indexing/lucene/<indexName>} in {@code root}.
    ...
    public LuceneNgIndexNode(@NotNull String indexPath,
        ...
        this.storageState = resolveStorageState(root, indexName);
    ...
    /**
     * Returns the immutable storage state at {@code /var/indexing/lucene/<indexName>}
    ...
    /**
     * Navigates root to {@code /var/indexing/lucene/<indexName>}.
     */
    private static NodeState resolveStorageState(NodeState root, String indexName) {
        return root
                .getChildNode("var")
