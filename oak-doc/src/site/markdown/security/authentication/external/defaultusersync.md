...
- System sessions and configured service user principals (see `systemPrincipalNames` option) are
...
See section [Introduction to Oak Security](../../introduction.html) for further details on
