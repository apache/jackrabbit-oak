...
- everyone is can read the complete tree defined by /content _except_ for properties named 'prop1'
  or 'prop2' which are explicitly denied by the restricting entry.
...
- a subject containing the 'jackrabbit' user principal has full permission at /home/jackrabbit
  irrespective of the presense of everyone group principal in the subject.
...
- a subject containing the 'jackrabbit' user principal has full permission at the tree defined by
  /home/jackrabbit irrespective of the presense of everyone group principal in the subject.
...
1. The _permission entries_ are [analyzed](#entry_evaluation) if they include the respective
   ...
   by the way how they are stored in the [permission store](default.html#permissionStore) and how
   they
   are feed into the iterator (see [Order and Evaluation of Permission Entries](#permissionentries)
   above).
