...
public class CheckValidRepositoryTest extends CheckRepositoryTestBase {
    ...
    public void testSuccessfulFullCheckWithBinaryTraversal() throws Exception {
        ...
        assertExpectedOutput(strOut.toString(), Lists.new ArrayList<>("Checking head", "Searched through 1 revisions and 0 checkpoints",
            "Checked 7 nodes and 21 properties", "Path / is consistent"));
        assertExpectedOutput(strErr.toString(), Lists.new ArrayList<>(""));
    }
    ...
    public void testUnsuccessfulPartialCheckWithoutBinaryTraversal() throws Exception {
        ...
        assertExpectedOutput(strErr.toString(), Lists.new ArrayList<>("Path /g not found"));
    }
    ...
    public void testSuccessfulCheckOfHeadAndCheckpointsWithoutFilterPaths() throws Exception {
        ...
        assertExpectedOutput(strOut.toString(), Lists.new ArrayList<>("Checking head", "Checking checkpoints",
    ...
    public void testMissingCheckpointCheck() throws Exception {
        ...
        assertExpectedOutput(strOut.toString(), Lists.new ArrayList<>("Checking checkpoints", "Searched through 1 revisions and 1 checkpoints",
            "No good revision found"));
        assertExpectedOutput(strErr.toString(), Lists.new ArrayList<>("Checkpoint bogus-checkpoint not found in this revision!"));
    }
}
