...
/**
 * MBean for monitoring and interacting with the {@link SegmentCompactionIT} longevity test.
 */
public interface SegmentCompactionMBean {
    ...
    /**
     * Set the core pool size of the scheduler used to execute concurrent operations.
     *
     * @param corePoolSize
     */
    ...
    /**
     * @return the core pool size of the scheduler used to execute concurrent operations.
     */
    int getCorePoolSize();
