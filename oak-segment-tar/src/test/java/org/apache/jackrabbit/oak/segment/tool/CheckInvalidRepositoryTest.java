...
public class CheckInvalidRepositoryTest extends CheckRepositoryTestBase {
    ...
    public void testInvalidRevisionFallbackOnValid() {
        ...
        assertExpectedOutput(log.outString(), Lists.new ArrayList<>("Checked 7 nodes and 21 properties", "Path / is consistent",
            "Searched through 2 revisions"));

        // not sure whether first traversal will fail because of "/a" or "/z"
        assertExpectedOutput(log.errString(), Lists.new ArrayList<>("Error while traversing /"));
    }
    ...
    public void testPartialBrokenPathWithoutValidRevision() {
        ...
        assertExpectedOutput(log.outString(), Lists.new ArrayList<>("Checking head", "Checking checkpoints", "No good revision found"));
    ...
    public void testPartialBrokenPathWithValidRevision() {
        ...
        assertCheckSucceeded(checkResult);
        assertExpectedOutput(log.outString(), Lists.new ArrayList<>("Checked 1 nodes and 1 properties", "Path /a is consistent",
            "Searched through 2 revisions"));
        assertExpectedOutput(log.errString(), Lists.new ArrayList<>(
    ...
    public void testCorruptHeadWithValidCheckpoints() {
        ...
        assertCheckSucceeded(checkResult);
        assertExpectedOutput(log.outString(), Lists.new ArrayList<>("Checking head", "Checking checkpoints",
    ...
    public void testCorruptPathInCp1NoValidRevision() throws Exception {
        ...
        assertCheckFailed(checkResult);
        assertExpectedOutput(log.outString(), Lists.new ArrayList<>("Searched through 2 revisions and 1 checkpoints", "No good revision found"));
        assertExpectedOutput(log.errString(), Lists.new ArrayList<>(
    ...
    public void testLargeJournal() throws IOException {
        ...
        assertCheckFailed(checkResult);
        assertExpectedOutput(log.outString(), Lists.new ArrayList<>("No good revision found"));
    }
    ...
    public void testFailFast_withInvalidHead() {
        ...
        assertCheckFailed(checkResult);
        assertExpectedOutput(log.outString(), Lists.new ArrayList<>("Searched through 1 revisions and 2 checkpoints", "No good revision found"));
    }
    ...
    public void testFailFast_withInvalidCheckpoints() {
        ...
        assertCheckFailed(checkResult);
        assertExpectedOutput(log.outString(), Lists.new ArrayList<>("Path /b is consistent", "No good revision found"));
        assertExpectedOutput(log.errString(), Lists.new ArrayList<>("Checkpoint invalid-checkpoint-id not found in this revision!"));
    }
