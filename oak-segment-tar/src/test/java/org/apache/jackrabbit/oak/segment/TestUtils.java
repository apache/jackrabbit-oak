...
public final class TestUtils {
    ...
    /**
     * Returns a new valid record offset, between {@code a} and {@code b}, exclusive.
     */
     ...
     */
    public static Map<RecordId, RecordId> randomRecordIdMap(Random rnd,
        SegmentIdProvider idProvider,
