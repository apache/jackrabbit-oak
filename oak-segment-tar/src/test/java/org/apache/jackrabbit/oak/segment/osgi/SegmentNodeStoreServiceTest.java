...
public class SegmentNodeStoreServiceTest {
    ...
    public void testComponentDescriptor() throws Exception {
        ComponentDescriptor cd = ComponentDescriptor.open(getClass().getResourceAsStream(
            "/OSGI-INF/org.apache.jackrabbit.oak.segment.SegmentNodeStoreService.xml"));
        ...
        assertTrue(
            cd.hasImplementationClass("org.apache.jackrabbit.oak.segment.SegmentNodeStoreService"));
    ...
    public void testMetatypeInformation() throws Exception {
        MetatypeInformation mi = MetatypeInformation.open(getClass().getResourceAsStream(
            "/OSGI-INF/metatype/org.apache.jackrabbit.oak.segment.SegmentNodeStoreService$Configuration.xml"));
        assertTrue(mi.hasDesignate()
                     .withPid("org.apache.jackrabbit.oak.segment.SegmentNodeStoreService")
                     .withReference(
                         "org.apache.jackrabbit.oak.segment.SegmentNodeStoreService$Configuration")
                     .check());
