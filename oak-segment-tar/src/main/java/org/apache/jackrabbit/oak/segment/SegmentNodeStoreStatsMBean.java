...
public interface SegmentNodeStoreStatsMBean {
    ...
    /**
     * @return tabular data of the form &lt;commits,writer&gt; for writers not included in groups
     * @throws OpenDataException if data is not available
     */
    TabularData getCommitsCountForOtherWriters() throws OpenDataException;

    /**
     * @return tabular data of the form <em>&lt;writer, writerDetails, queued, dequed,
     * applied&gt;</em> for each writer currently in the queue
     * @throws OpenDataException if data is not available
     */
    TabularData getQueuedWriters() throws OpenDataException;

    /**
     * @return data of the form <em>&lt;writer, writerDetails, queued, dequed, applied&gt;</em> for
     * the writer currently in committing. @{@code null} if none.
     * @throws OpenDataException if data is not available
     */
    CompositeData getCurrentWriter() throws OpenDataException;

    /**
     * Turns on/off, depending on the value of {@code flag}, the collection of stack traces for each
     * writer.
     *
    ...
    /**
     * @return maximum number of writers outside already defined groups to be recorded
     */
    ...
    /**
     * Modifies the groups used for grouping writers. Changing the default value will reset the
