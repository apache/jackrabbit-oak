...
public class SegmentNodeStoreStats implements SegmentNodeStoreStatsMBean, SegmentNodeStoreMonitor {
    ...
    private static final int OTHER_WRITERS_LIMIT = Integer.getInteger(
        "oak.commitsTracker.otherWritersLimit", 20);
    ...
    public SegmentNodeStoreStats(StatisticsProvider statisticsProvider) {
        ...
        this.commitQueueSize = statisticsProvider.getCounterStats(COMMIT_QUEUE_SIZE,
    ...
    public TabularData getCommitsCountPerWriterGroupLastMinute() throws OpenDataException {
        return createTabularDataFromCountMap(commitsTracker.getCommitsCountPerGroupLastMinute(),
            "commitsPerWriterGroup",
            "writerGroup");
    }

    @Override
    public TabularData getCommitsCountForOtherWriters() throws OpenDataException {
        return createTabularDataFromCountMap(commitsTracker.getCommitsCountOthers(),
            "commitsPerWriter",
            "writerName");
    }

    private TabularData createTabularDataFromCountMap(Map<String, Long> commitsCountMap,
        String typeName,
        ...
        TabularDataSupport tabularData = new TabularDataSupport(
            new TabularType(typeName, "Most active writers",
    ...
    private static CompositeType getCompositeType(String name) throws OpenDataException {
        return new CompositeType(
            name, name,
            new String[]{"writerName", "writerDetails", "GCGeneration", "queued", "dequeued",
                "applied"},
            new String[]{"writerName", "writerDetails", "GCGeneration", "queued", "dequeued",
                "applied"},
