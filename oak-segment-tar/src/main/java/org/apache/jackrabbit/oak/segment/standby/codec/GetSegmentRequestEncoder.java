...
public class GetSegmentRequestEncoder extends MessageToMessageEncoder<GetSegmentRequest> {
    ...
    @Override
    protected void encode(ChannelHandlerContext ctx, GetSegmentRequest msg, List<Object> out)
        throws Exception {
        log.debug("Sending request from client {} for segment {}", msg.getClientId(),
            msg.getSegmentId());
