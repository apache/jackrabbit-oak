...
public interface JackrabbitSession extends Session {
    ...
    /**
     * A constant representing the {@code add_property} action string, used to determine if this
     * {@code Session} has permission to add a new property.
     *
    ...
    /**
     * A constant representing the {@code modify_property} action string, used to determine if this
     * {@code Session} has permission to modify a property.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * A constant representing the {@code remove_property} action string, used to determine if this
     * {@code Session} has permission to remove a property.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * A constant representing the {@code remove_node} action string, used to determine if this
     * {@code Session} has permission to remove a node.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * A constant representing the {@code node_type_management} action string, used to determine if
     * this {@code Session} has permission to write node type information of a node.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * A constant representing the {@code versioning} action string, used to determine if this
     * {@code Session} has permission to perform version operations on a node.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * A constant representing the {@code locking} action string, used to determine if this
     * {@code Session} has permission to lock or unlock a node.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * A constant representing the {@code read_access_control} action string, used to determine if
     * this {@code Session} has permission to read access control content at the given path.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * A constant representing the {@code modify_access_control} action string, used to determine if
     * this {@code Session} has permission to modify access control content at the given path.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * A constant representing the {@code user_management} action string, used to determine if this
     * {@code Session} has permission to perform user management operations at the given path.
     *
     * @see #hasPermission(String, String...)
     */
    ...
    /**
     * Returns {@code true} if this {@code Session} has permission to perform the specified actions
     * at the specified {@code absPath} and {@code false} otherwise.
     * <p>
     * The {@code actions} parameter is a list of action strings. Apart from the actions defined on
     * {@link Session}, this variant also allows to specify the following additional actions to
     * provide better permission discovery:
     * <ul>
     * <li> {@link
     ...
     * @return {@code true} if this {@code Session} has permission to perform the specified actions
     * actions at the specified {@code absPath}.
     ...
     * @throws AccessDeniedException                   If the session lacks privileges to access the
     *                                                 principal manager or principals in general.
     * @throws UnsupportedRepositoryOperationException If principal management is not supported.
     ...
     * @throws javax.jcr.AccessDeniedException         If this session is not allowed to to access
     *                                                 user data.
     * @throws UnsupportedRepositoryOperationException If user management is not supported.
     ...
     * then it returns the property at the specified path. If no such property exists, then it
     * return {@code null}.
     *
     * @param absPath An absolute path.
    ...
    /**
     * Returns the property at the specified absolute path in the workspace or {@code null} if no
     * such node exists.
     *
     * @param absPath An absolute path.
    ...
    /**
     * Returns the node at the specified absolute path in the workspace or {@code null} if no such
     * node exists.
     *
     * @param absPath An absolute path.
    ...
    /**
     * Returns the parent of the given {@code Item} or {@code null} if no parent exists (either
     * because the given {@code Item} represents the root node or the current session does not have
     * sufficient access to retrieve the parent).
     *
