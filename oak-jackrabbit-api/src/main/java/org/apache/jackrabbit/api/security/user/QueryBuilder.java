...
public interface QueryBuilder<T> {
    ...
    /**
     * Set the selector for the query. The selector determines whether the query returns all
     * {@link Authorizable}s or just {@link User}s respectively {@link Group}s.
     *
    ...
    /**
     * Set the condition for the query. The query only includes {@link Authorizable}s for which this
     * condition holds.
     *
     * @param condition Condition upon which <code>Authorizables</code> are included in the query
     *                  result
     */
    void setCondition(@NotNull T condition);

    /**
     * Set the sort order of the {@link Authorizable}s returned by the query. The format of the
     * <code>propertyName</code> is the same as in XPath:
     ...
     * @param direction    Direction to sort. Either {@link Direction#ASCENDING} or
     *                     {@link Direction#DESCENDING}
     * @param ignoreCase   Ignore character case in sort if <code>true</code>. Note: For
     *                     <code>false</code> sorting is done lexicographically even for non string
     *                     properties.
     */
    ...
    /**
     * Set limits for the query. The limits consists of a bound and a maximal number of results. The
     * bound refers to the value of the {@link #setSortOrder(String, Direction) sort order}
     * property. The query returns at most <code>maxCount</code> {@link Authorizable}s whose values
     * of the sort order property follow <code>bound</code> in the sort direction. This method has
     * no effect if the sort order is not specified.
     *
     * @param bound    Bound from where to start returning results. <code>null</code> for no bound
     * @param maxCount Maximal number of results to return. -1 for no limit.
     */
    void setLimit(@Nullable Value bound, long maxCount);

    /**
     * Set limits for the query. The limits consists of an offset and a maximal number of results.
     * <code>offset</code> refers to the offset within the full result set at which the returned
     * result set should start expressed in terms of the number of {@link Authorizable}s to skip.
     * <code>maxCount</code> sets the maximum size of the result set expressed in terms of the
     * number of authorizables to return.
     *
    ...
    /**
     * Create a condition which holds if the name of the {@link Authorizable} matches a
     * <code>pattern</code>. The percent character "%" represents any string of zero or more
     * characters and the underscore character "_" represents any single character. Any literal use
     * of these characters and the backslash character "\" must be escaped with a backslash
     * character. The pattern is matched against the {@link Authorizable#getID() id} and the
    ...
    /**
     * Create a condition which holds if the node of an {@link Authorizable} has a property at
     * <code>relPath</code> which is not equal to <code>value</code>. The format of the
     * <code>relPath</code> argument is the same as in XPath:
    ...
    /**
     * Create a condition which holds if the node of an {@link Authorizable} has a property at
     * <code>relPath</code> which is equal to <code>value</code>. The format of the
     * <code>relPath</code> argument is the same as in XPath:
     * <code>@attributeName</code> for an attribute on this node and
     * <code>relative/path/@attributeName</code> for an attribute of a descendant node.
     *
    ...
    /**
     * Create a condition which holds if the node of an {@link Authorizable} has a property at
     * <code>relPath</code> which is smaller than <code>value</code>. The format of the
     * <code>relPath</code> argument is the same as in XPath:
     * <code>@attributeName</code> for an attribute on this node and
     * <code>relative/path/@attributeName</code> for an attribute of a descendant node.
     *
    ...
    /**
     * Create a condition which holds if the node of an {@link Authorizable} has a property at
     * <code>relPath</code> which is smaller than or equal to <code>value</code>. The format of the
     * <code>relPath</code> argument is the same as in XPath:
     * <code>@attributeName</code> for an attribute on this node and
     * <code>relative/path/@attributeName</code> for an attribute of a descendant node.
     *
    ...
    /**
     * Create a condition which holds if the node of an {@link Authorizable} has a property at
     * <code>relPath</code> which is greater than <code>value</code>. The format of the
     * <code>relPath</code> argument is the same as in XPath:
     * <code>@attributeName</code> for an attribute on this node and
     * <code>relative/path/@attributeName</code> for an attribute of a descendant node.
     *
    ...
    /**
     * Create a condition which holds if the node of an {@link Authorizable} has a property at
     * <code>relPath</code> which is greater than or equal to <code>value</code>. The format of the
     * <code>relPath</code> argument is the same as in XPath:
     * <code>@attributeName</code> for an attribute on this node and
     * <code>relative/path/@attributeName</code> for an attribute of a descendant node.
     *
    ...
    /**
     * Create a condition which holds if the node of an {@link Authorizable} has a property at
     * <code>relPath</code>. The format of the <code>relPath</code> argument is the same as in
     * XPath:
     * <code>@attributeName</code> for an attribute on this node and
     * <code>relative/path/@attributeName</code> for an attribute of a descendant node.
     *
    ...
    /**
     * Create a condition which holds if the node of an {@link Authorizable} has a property at
     * <code>relPath</code> which matches the pattern in <code>pattern</code>. The percent
     * character
     * "%" represents any string of zero or more characters and the underscore character "_"
     * represents any single character. Any literal use of these characters and the backslash
     * character "\" must be escaped with a backslash character. The format of the
     * <code>relPath</code> argument is the same as in XPath:
     * <code>@attributeName</code> for an attribute on this node and
     * <code>relative/path/@attributeName</code> for an attribute of a descendant node.
     *
     ...
     * of the descendant node at relative/path. The syntax of <code>searchExpr</code> is
     * <pre>[-]value { [OR] [-]value }</pre>.
     *
     * @param relPath    Relative path from the authorizable's node to the property
