...
public class UserManagerDelegatorTest extends AbstractDelegatorTest {
    ...
    private static void verifySessionDelegatePerform(@NotNull SessionDelegate sessionDelegate,
    ...
    private static void verifySessionDelegatePerformNullable(
        @NotNull SessionDelegate sessionDelegate, int times) throws Exception {
        verify(sessionDelegate, times(times)).checkAlive();
        verify(sessionDelegate, times(times)).isAlive();
    ...
    public void testFindAuthorizables() throws Exception {
        ...
        doReturn(Collections.emptyIterator()).when(um)
    ...
    public void testCreateUser() throws Exception {
        ...
        doReturn(user).when(um)
                      .createUser(anyString(), anyString(), any(Principal.class), anyString());
