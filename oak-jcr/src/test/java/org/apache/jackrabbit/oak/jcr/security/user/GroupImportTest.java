...
public class GroupImportTest extends AbstractImportTest {
    ...
    public void testImportNewMembers() throws Exception {
        ...
        assertTrue(
            n.hasProperty(UserConstants.REP_MEMBERS) || n.hasNode(UserConstants.NT_REP_MEMBERS));
    ...
    public void testImportMembers() throws Exception {
        Session s = getImportSession();
        Authorizable admin = checkNotNull(
            getUserManager().getAuthorizable(UserConstants.DEFAULT_ADMIN_ID));
    ...
    public void testImportGroupMembersFromNodes() throws Exception {
        ...
        try {
            String[] users = {"angi", "adi", "hansi", "lisi", "luzi", "susi", "pipi", "hari",
                "gabi", "eddi",
            ...
            for (String user : users) {
                assertTrue(user + " should be member of " + gShrimps,
                    gShrimps.isMember(uMgr.getAuthorizable(user)));
            }
    ...
    public void testImportGroupMembersFromOakNodes() throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < 32; i++) {
                String user = "testUser" + i;
                assertTrue(user + " should be member of " + testGroup,
                    testGroup.isMember(uMgr.getAuthorizable(user)));
            }
