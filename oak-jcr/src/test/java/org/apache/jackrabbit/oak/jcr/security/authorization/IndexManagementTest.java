...
public class IndexManagementTest extends AbstractEvaluationTest {
    ...
    public void testAddOakIndexWithoutPermission() throws Exception {
        ...
        try {
            ...
            testSession.save();
            fail(
                "AccessDeniedException expected. Test session is not allowed to add oak:index node.");
    ...
    public void testAddIndexDefinitionWithoutPermission() throws Exception {
        ...
        try {
            ...
            testSession.save();
            fail(
                "AccessDeniedException expected. Test session is not allowed to add index definition node.");
        } catch (AccessDeniedException e) {
            // success
        }
    }
    ...
    public void testModifyIndexDefinition() throws Exception {
        Node indexDef = superuser.getNode(path).addNode(IndexConstants.INDEX_DEFINITIONS_NAME)
                                 .addNode("myIndex", IndexConstants.INDEX_DEFINITIONS_NODE_TYPE);
    ...
    public void testModifyIndexDefinitionWithoutPermission() throws Exception {
        ...
        try {
            ...
            testSession.save();
            fail(
                "AccessDeniedException expected. Test session is not allowed to add index definition property.");
        } catch (AccessDeniedException e) {
            // success
        }
    }
    ...
    public void testModifyIndexDefinitionWithoutPermission3() throws Exception {
        ...
        try {
            ...
            testSession.save();
            fail(
                "AccessDeniedException expected. Test session is not allowed to modify index definition property.");
        } catch (AccessDeniedException e) {
            // success
        }
    }
    ...
    public void testModifyIndexDefinitionWithoutPermission4() throws Exception {
        ...
        try {
            ...
            testSession.save();
            fail(
                "AccessDeniedException expected. Test session is not allowed to remove index definition property.");
        } catch (AccessDeniedException e) {
            // success
        }
    }
    ...
    public void testRemoveIndexDefinitionWithoutPermission() throws Exception {
        ...
        try {
            ...
            testSession.save();
            fail(
                "AccessDeniedException expected. Test session is not allowed to remove index definition node.");
        } catch (AccessDeniedException e) {
            // success
        }
    }
    ...
    public void testRemoveOakIndexWithoutPermission() throws Exception {
        ...
        try {
            ...
            testSession.save();
            fail(
                "AccessDeniedException expected. Test session is not allowed to remove oak:index.");
        } catch (AccessDeniedException e) {
            // success
        }
    }
    ...
    public void testAddAccessControlToIndexDefinition() throws Exception {
        ...
        try {
            Node n = testSession.getNode(path).addNode(IndexConstants.INDEX_DEFINITIONS_NAME)
                                .addNode("myIndex", IndexConstants.INDEX_DEFINITIONS_NODE_TYPE);
            n.setProperty(IndexConstants.TYPE_PROPERTY_NAME, "myType");
