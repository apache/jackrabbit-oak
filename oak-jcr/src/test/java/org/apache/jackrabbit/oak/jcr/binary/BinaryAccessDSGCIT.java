...
public class BinaryAccessDSGCIT extends AbstractBinaryAccessIT {
    ...
    public void testGC() throws Exception {
        ...
        for (String key : Lists.new ArrayList<>(TRADITIONAL_UPLOAD_1, TRADITIONAL_UPLOAD_2)) {
        ...
        for (String key : Lists.new ArrayList<>(DIRECT_UPLOAD_1, DIRECT_UPLOAD_2)) {
            Content content = Content.createRandom(BINARY_SIZE);
            binaryContent.put(key, content);
        ...
        List<String> deletedBinaryPaths = Lists.new ArrayList<>(TRADITIONAL_UPLOAD_2, DIRECT_UPLOAD_2);
        ...
        for (String deletedPath : Lists.new ArrayList<>(TRADITIONAL_UPLOAD_2, DIRECT_UPLOAD_2)) {
