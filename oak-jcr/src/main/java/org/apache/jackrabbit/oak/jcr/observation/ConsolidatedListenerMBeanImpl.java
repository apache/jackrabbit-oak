...
public class ConsolidatedListenerMBeanImpl implements ConsolidatedListenerMBean {
    ...
    /**
     * Performs the mapping between EventListenerMBean and the Observer based on the JMX ObjectName
     * service property of the MBean
     *
    ...
    @SuppressWarnings("unused")
    protected void bindBackgroundObserverMBean(BackgroundObserverMBean mbean,
        Map<String, ?> config) {
        bgObservers.put(getObjectName(config), mbean);
    }

    @SuppressWarnings("unused")
    protected void unbindBackgroundObserverMBean(BackgroundObserverMBean mbean,
        Map<String, ?> config) {
    ...
    private static class ListenerStatsData {
        ...
        CompositeDataSupport toCompositeData() {
            Object[] values = new Object[]{
                ...
                mbeans.filterConfigMBean == null ? "n/a"
                    : Arrays.toString(mbeans.filterConfigMBean.getPaths()),
                mbeans.filterConfigMBean != null
    ...
    private static class LeaderBoardData {
        ...
        public LeaderBoardData(int i, EventListenerMBean mbean,
            FilterConfigMBean filterConfigMBean) {
            this(i, mbean, filterConfigMBean, mbean.getEventProducerTime(),
                mbean.getEventConsumerTime());
        }
