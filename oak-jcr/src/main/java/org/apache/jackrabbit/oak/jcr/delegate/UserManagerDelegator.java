...
/**
 * This implementation of {@code UserManager} delegates back to a delegatee wrapping each call into
 * a {@link UserManager} closure.
 *
...
public class UserManagerDelegator implements UserManager {
    ...
    @Nullable
    @Override
    public <T extends Authorizable> T getAuthorizable(@NotNull final String id,
        @NotNull final Class<T> authorizableClass) throws RepositoryException {
        return sessionDelegate.performNullable(
            new UserManagerOperation<T>(sessionDelegate, "getAuthorizable") {
                @Override
                public T performNullable() throws RepositoryException {
                    Authorizable authorizable = userManagerDelegate.getAuthorizable(id);
                    return UserUtil.castAuthorizable(
                        AuthorizableDelegator.wrap(sessionDelegate, authorizable),
                        authorizableClass);
    ...
    @Nullable
    @Override
    public Authorizable getAuthorizable(@NotNull final Principal principal)
    ...
    @Nullable
    @Override
    public Authorizable getAuthorizableByPath(@NotNull final String path)
        throws RepositoryException {
        return sessionDelegate.performNullable(
    ...
    @NotNull
    @Override
    public Iterator<Authorizable> findAuthorizables(@NotNull final String relPath,
        @Nullable final String value) throws RepositoryException {
        return sessionDelegate.perform(
            new UserManagerOperation<Iterator<Authorizable>>(sessionDelegate, "findAuthorizables") {
                ...
                public Iterator<Authorizable> perform() throws RepositoryException {
                    Iterator<Authorizable> authorizables = userManagerDelegate.findAuthorizables(
                        relPath, value);
                    return Iterators.transform(authorizables,
                        authorizable -> AuthorizableDelegator.wrap(sessionDelegate, authorizable));
                }
            });
    }
    ...
    @Override
    public Iterator<Authorizable> findAuthorizables(@NotNull final String relPath,
        @Nullable final String value, final int searchType) throws RepositoryException {
        return sessionDelegate.perform(
            new UserManagerOperation<Iterator<Authorizable>>(sessionDelegate, "findAuthorizables") {
                @NotNull
                @Override
    ...
    @NotNull
    @Override
    public Iterator<Authorizable> findAuthorizables(@NotNull final Query query)
        throws RepositoryException {
        return sessionDelegate.perform(
            new UserManagerOperation<Iterator<Authorizable>>(sessionDelegate, "findAuthorizables") {
                @NotNull
    ...
    @NotNull
    @Override
    public User createUser(@NotNull final String userID, @Nullable final String password)
        throws RepositoryException {
        return sessionDelegate.perform(
            new UserManagerOperation<User>(sessionDelegate, "createUser", true) {
                @NotNull
                @Override
    ...
    @Override
    public User createUser(@NotNull final String userID, @Nullable final String password,
        @NotNull final Principal principal, @Nullable final String intermediatePath)
        throws RepositoryException {
        return sessionDelegate.perform(
            new UserManagerOperation<User>(sessionDelegate, "createUser", true) {
                @NotNull
                @Override
                public User perform() throws RepositoryException {
                    User user = userManagerDelegate.createUser(userID, password, principal,
                        intermediatePath);
                    return UserDelegator.wrap(sessionDelegate, user);
                }
            });
    ...
    @NotNull
    @Override
    public User createSystemUser(@NotNull final String userID,
    ...
    public Group createGroup(@NotNull final String groupID) throws RepositoryException {
        return sessionDelegate.perform(
            new UserManagerOperation<Group>(sessionDelegate, "createGroup", true) {
                @NotNull
                @Override
    ...
    @NotNull
    @Override
    public Group createGroup(@NotNull final Principal principal,
        @Nullable final String intermediatePath) throws RepositoryException {
        return sessionDelegate.perform(
            new UserManagerOperation<Group>(sessionDelegate, "createGroup", true) {
                @NotNull
    ...
    @NotNull
    @Override
    public Group createGroup(@NotNull final String groupID, @NotNull final Principal principal,
        @Nullable final String intermediatePath) throws RepositoryException {
        return sessionDelegate.perform(
            new UserManagerOperation<Group>(sessionDelegate, "createGroup", true) {
                @NotNull
                @Override
                public Group perform() throws RepositoryException {
                    Group group = userManagerDelegate.createGroup(groupID, principal,
                        intermediatePath);
                    return GroupDelegator.wrap(sessionDelegate, group);
                }
            });
