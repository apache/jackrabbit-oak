...
/**
 * Wrapper around the map that allows accessing the map with case-insensitive keys. For example, the
 * keys 'hello' and 'Hello' access the same value.
 * <p>
...
public class CaseInsensitiveKeysMapAccess {
     ...
     * <p>
     * Return an unmodifiable map to make it clear that changes are not reflected to the original
     * map.
     *
