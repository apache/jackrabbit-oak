...
/**
 * TypeCodes maps between {@code Type} and the code used to prefix its json serialisation.
 */
public final class TypeCodes {
    ...
    /**
     * Encodes the given {@code propertyName} of the given {@code propertyType} into a json string,
    ...
    /**
     * Splits a {@code jsonString}, which is prefixed with a type code at the location where the
     * prefix ends.
     *
