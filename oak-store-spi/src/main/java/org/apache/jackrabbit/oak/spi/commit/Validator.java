...
/**
 * Content change validator. An instance of this interface is used to validate changes against a
 * specific {@link NodeState}.
 *
...
public interface Validator extends Editor {
     ...
     * @return a {@code Validator} for {@code after} or {@code null} if validation should not decent
     * into the subtree rooted at {@code after}.
     * @throws CommitFailedException if validation fails.
     */
    @Nullable
     ...
     * @param before the original node
     * @return a {@code Validator} for the removed subtree or {@code null} if validation should not
     * decent into the subtree
     * @throws CommitFailedException if validation fails.
     */
    @Nullable
