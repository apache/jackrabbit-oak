...
public abstract class AbstractMutableTree extends AbstractTree {
    ...
    protected AbstractMutableTree(@Nonnull String name, @Nonnull NodeBuilder nodeBuilder) {
     ...
     * are not yet reflected in the {@link org.apache.jackrabbit.oak.plugins.tree.TreeConstants#OAK_CHILD_ORDER}
