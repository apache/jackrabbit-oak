...
public class SegmentTarToSegmentAzureServicePrincipalTest extends AbstractOak2OakTest {
    ...
    public void prepare() throws Exception {
        assumeNotNull(ENVIRONMENT.getVariable(AzureUtilities.AZURE_ACCOUNT_NAME),
            ENVIRONMENT.getVariable(AzureUtilities.AZURE_TENANT_ID),
            ENVIRONMENT.getVariable(AzureUtilities.AZURE_CLIENT_ID),
            ENVIRONMENT.getVariable(AzureUtilities.AZURE_CLIENT_SECRET));
        skipTest = false;
        super.prepare();
    }
