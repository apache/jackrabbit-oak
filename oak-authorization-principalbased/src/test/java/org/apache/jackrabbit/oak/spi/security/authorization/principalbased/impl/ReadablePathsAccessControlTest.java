...
public class ReadablePathsAccessControlTest extends AbstractPrincipalBasedTest {
    ...
    public void testHasPrivilege() throws Exception {
        try (ContentSession cs = Java23Compatability.doAsPrivileged(getTestSubject(), (PrivilegedExceptionAction<ContentSession>) () -> getContentRepository().login(null, null), null)) {
