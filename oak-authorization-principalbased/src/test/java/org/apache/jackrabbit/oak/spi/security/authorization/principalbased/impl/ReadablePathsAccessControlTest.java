...
public class ReadablePathsAccessControlTest extends AbstractPrincipalBasedTest {
    ...
    public void testHasPrivilege() throws Exception {
        try (ContentSession cs = Java23Compatibility.doAsPrivileged(getTestSubject(), (PrivilegedExceptionAction<ContentSession>) () -> getContentRepository().login(null, null), null)) {
