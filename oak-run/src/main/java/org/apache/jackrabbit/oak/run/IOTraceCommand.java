...
class IOTraceCommand implements Command {
    ...
    public void execute(String... args) throws Exception {
        ...
        ArgumentAcceptingOptionSpec<Traces> traceOption = optionParser
            .accepts("trace",
                "type of the traversal. Either of " + Arrays.toString(Traces.values()))
            .withRequiredArg()
            .ofType(Traces.class)
            .required();
        ...
        try {
            ...
            File segmentStore = isValidFileStoreOrFail(
                new File(options.nonOptionArguments().get(0).toString()));
