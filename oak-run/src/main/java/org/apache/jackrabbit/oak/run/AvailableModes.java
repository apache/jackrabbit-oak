...
public final class AvailableModes {
    ...
    public static final Modes MODES = new Modes(
        ImmutableMap.<String, Command>builder()
                    ...
                    .put(FrozenNodeRefsByScanningCommand.NAME,
                        new FrozenNodeRefsByScanningCommand())
                    .put(FrozenNodeRefsUsingIndexCommand.NAME,
                        new FrozenNodeRefsUsingIndexCommand())
