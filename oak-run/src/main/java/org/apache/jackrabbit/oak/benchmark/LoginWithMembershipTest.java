...
public class LoginWithMembershipTest extends AbstractLoginTest {
    ...
    public static final int NO_GROUPS_DEFAULT = 10;

    private final int noGroups;
    private final boolean nestedGroups;

    public LoginWithMembershipTest(boolean runWithToken, int noIterations, int noGroups, boolean nestedGroups) {
