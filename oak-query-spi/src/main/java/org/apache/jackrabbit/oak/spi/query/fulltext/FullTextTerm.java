...
public class FullTextTerm extends FullTextExpression {
    ...
    public FullTextTerm(String propertyName, String text, boolean not, boolean escaped,
        String boost) {
        this.propertyName = propertyName;
        this.text = text;
        this.not = not;
    ...
    /**
     * Whether or not the given character is part of a full-text term that should be indexed. Not
     * indexed are punctuation, control characters such as tab,
     * <p>
     * See also <a href=
     * "http://en.wikipedia.org/wiki/Character_property_(Unicode)#General_Category" > Unicode
     * Categories</a>.
     *
