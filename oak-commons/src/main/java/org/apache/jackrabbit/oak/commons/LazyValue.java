...
/**
 * An instances of this class represents a lazy value of type {@code T}. {@code LazyValue}
 * implements an evaluate by need semantics: {@link #createValue()} is called exactly once when
 * {@link #get()} is called for the first time.
 * <p>
