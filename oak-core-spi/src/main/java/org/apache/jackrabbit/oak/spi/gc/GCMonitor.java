...
/**
 * {@code GCMonitor} instance are used to monitor garbage collection. Instances of {@code GCMonitor}
 * are registered to the {@link Whiteboard} to receive notifications regarding garbage collection.
 */
public interface GCMonitor {
    ...
    /**
     * Warning about a condition that might have adverse effects on the overall garbage collection
     * process but does not prevent the process from running.
     *
     * @param message   The message with {} place holders for the {@code arguments}
     * @param arguments
     */
