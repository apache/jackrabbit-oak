 ...
 *
 * <p>The configuration may either be trivial - only a default mount is configured, or defining at
 * least one non-default mount.</p>
 */
@ProviderType
public interface MountInfoProvider {
     ...
     * @return mountInfo for the given path. If no explicit mount configured then default mount
     * would be returned
     */
    @NotNull
     ...
     * @return mount instance for given mount name. If no mount exists for given name {@code null}
     * would be returned
     */
    @Nullable
