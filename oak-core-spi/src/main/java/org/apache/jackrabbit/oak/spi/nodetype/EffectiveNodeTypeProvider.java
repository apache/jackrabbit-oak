...
public interface EffectiveNodeTypeProvider {
    ...
    /**
     * Returns {@code true} if this tree is of the specified primary node type or mixin type, or a
     * subtype thereof respecting the effective node type of the {@code tree}. Returns {@code false}
     * otherwise.
     * <p>
     * Note: caution must be taken while calling this api because it doesn't offer the same strict
     * guarantees as the {@code Node#isNodeType(String)} method in the case where the session
     * doesn't have access to the {@code jcr:mixinTypes} property.
     *
    ...
    /**
     * Returns {@code true} if {@code typeName} is of the specified primary node type or mixin type,
     * or a subtype thereof. Returns {@code false} otherwise.
     *
     ...
     * @throws NoSuchNodeTypeException If the specified node type name doesn't refer to an existing
     *                                 node type.
     * @throws RepositoryException     If the given node type name is invalid or if some other error
     *                                 occurs.
     * @deprecated use {@link #isNodeType(String, Iterable, String)} instead
     */
    @Deprecated
    default boolean isNodeType(@NotNull String primaryTypeName,
        @NotNull Iterator<String> mixinTypes, @NotNull String nodeTypeName)
     ...
     */
    default boolean isNodeType(@NotNull String primaryTypeName,
        @NotNull Iterable<String> mixinTypes, @NotNull String nodeTypeName)
        throws NoSuchNodeTypeException, RepositoryException {
     ...
     *                                 occurs.
     */
    boolean isNodeType(@NotNull String primaryTypeName,
        @NotNull Supplier<Iterable<String>> mixinTypes, @NotNull String nodeTypeName)
        throws NoSuchNodeTypeException, RepositoryException;
    ...
    /**
     * Calculates and returns the effective node types of the given node. Also see <a
     * href="http://www.jcp.org/en/jsr/detail?id=283">JCR 2.0 Specification, Section 3.7.6.5</a> for
     * the definition of the effective node type.
     *
     ...
     * @see <a href="http://www.jcp.org/en/jsr/detail?id=283">JCR 2.0 Specification, Section
     * 3.7.6.5</a>
     */
    @NotNull
    ...
    /**
     * Calculates and returns the effective node types of the given tree. Also see <a
     * href="http://www.jcp.org/en/jsr/detail?id=283">JCR 2.0 Specification, Section 3.7.6.5</a> for
     * the definition of the effective node type.
     *
     * @param tree the tree
