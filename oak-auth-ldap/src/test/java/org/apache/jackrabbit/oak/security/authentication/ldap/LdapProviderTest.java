...
public class LdapProviderTest {
    ...
    public void testGetUserProperties() throws Exception {
        ...
        assertThat((Map<String, Collection<String>>)user.getProperties(), Matchers.<String, Collection<String>>hasEntry(Matchers.equalTo("objectclass"), Matchers.containsInAnyOrder( "inetOrgPerson", "top", "person", "organizationalPerson")));
        assertThat(user.getProperties(), Matchers.<String, Object>hasEntry("uid", "hhornblo"));
        assertThat(user.getProperties(), Matchers.<String, Object>hasEntry("mail", "hhornblo@royalnavy.mod.uk"));
        assertThat(user.getProperties(), Matchers.<String, Object>hasEntry("givenname", "Horatio"));
        assertThat(user.getProperties(), Matchers.<String, Object>hasEntry("description", "Capt. Horatio Hornblower, R.N"));
        assertThat(user.getProperties(), Matchers.<String, Object>hasEntry("sn", "Hornblower"));
        assertThat(user.getProperties(), Matchers.<String, Object>hasEntry("cn", "Horatio Hornblower"));
    }
