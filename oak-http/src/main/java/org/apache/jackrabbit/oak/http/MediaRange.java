...
public class MediaRange {
     ...
     * <p>
     * The "derived" quality value if computed from the specified q value (0 to 1) by subtracting
     * 1/10000 in case the subtype in the range is "*", or 2/10000 if case both type and subtype
     * are. This takes care of the precedence specified in RFC 7231, Section 5.3.2.
     *
    ...
    public double match(MediaType type, MediaTypeRegistry registry) {
        ...
        } else if (q > 0.0 && "*".equals(this.type.getSubtype()) && type.getType().equals(
            this.type.getType())) {
