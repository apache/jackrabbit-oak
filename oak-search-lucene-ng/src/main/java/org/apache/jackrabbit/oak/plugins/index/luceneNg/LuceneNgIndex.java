...
public class LuceneNgIndex implements QueryIndex.AdvanceFulltextQueryIndex {
    ...
    public Cursor query(Filter filter, NodeState rootState) {
        ...
        try {
            ...
            // Cursor takes ownership of indexNode and releases it on close
            return new LuceneNgCursor(docs, searcher, indexNode);
    ...
    private static final NumericPoint<Long> LONG_POINT = new NumericPoint<Long>() {
        ...
        public Long nextAbove(Long v) { return Math.addExact(v, 1); }
        public Long nextBelow(Long v) { return Math.addExact(v, -1); }
        ...
        try {
            ...
            if (facetFields != null && !facetFields.isEmpty()) {
                ...
                if (sortOrder == null || sortOrder.isEmpty()) {
                    ...
                    Sort sort = createSort(sortOrder, definition);
                ...
                for (String facetField : facetFields) {
                    try {
                        ...
                        DefaultSortedSetDocValuesReaderState state =
                            indexNode.getFacetReaderState(luceneFieldName);
                        Facets facetsImpl;
            ...
            // Cursor takes ownership of indexNode and releases it on close
            return new LuceneNgCursor(docs, searcher, facetsMap, excerptMap, numberOfTopFacets, indexNode);
