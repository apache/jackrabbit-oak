...
public class IndexRootDirectoryTest {
    ...
    public void newFormat() throws Exception{
        FulltextIndexEditorContext.configureUniqueId(builder);
        File f1 = dir.getIndexDir(getDefn(), "/a/b", "default");
        File f2 = dir.getIndexDir(getDefn(), "/a/b", "default");
        assertEquals(f1, f2);
    }
    ...
    public void reindexCaseWithSamePath() throws Exception{
        ...
        FulltextIndexEditorContext.configureUniqueId(resetBuilder());
        File f2 = dir.getIndexDir(getDefn(), "/a/b", "default");
    ...
    private LuceneNgIndexDefinition getDefn(){
        return new LuceneNgIndexDefinition(root, builder.getNodeState(), "/foo");
    }
