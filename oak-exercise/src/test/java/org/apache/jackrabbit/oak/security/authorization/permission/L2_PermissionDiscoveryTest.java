...
public class L2_PermissionDiscoveryTest extends AbstractJCRTest {
    ...
    public void testRemovePermissions() throws RepositoryException {
        ...
        for (String pPath : removePropertyTests.keySet()) {
            ...
            assertEquals(canRemoveProperty, testSession.hasPermission(pPath, Session.ACTION_SET_PROPERTY));
        }
        ...
        for (String nodePath : removeNodesTests.keySet()) {
            boolean canRemoveProperty = removePropertyTests.get(nodePath);
            assertEquals(canRemoveProperty, testSession.hasPermission(nodePath, Session.ACTION_SET_PROPERTY));
        }


        // TODO : change the permission setup such that the following tests succeed.
    ...
    public void testOakPermissions() throws RepositoryException {
        String modifyPropertyPermissions = null; // TODO:
        assertFalse(testSession.hasPermission(propertyPath, modifyPropertyPermissions));

        // TODO : modify the permission setup such that the following tests pass
