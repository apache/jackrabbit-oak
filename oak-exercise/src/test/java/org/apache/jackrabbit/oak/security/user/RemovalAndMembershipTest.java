 ...
 */
public class RemovalAndMembershipTest extends AbstractSecurityTest {
    ...
    public void testMemberAfterRecreation() throws RepositoryException, CommitFailedException {
        ...
        // TODO: explain why is this user is still member of the test group?
    ...
    public void testNotMemberAfterRecreation() throws RepositoryException, CommitFailedException {
        ...
        // TODO : adjust the test-case such that upon re-creation the user is not member of administrators.
