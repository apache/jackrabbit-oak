 ...
 * </pre>
 *
 * @see org.apache.jackrabbit.oak.security.user.UserVsPrincipalTest
 */
public class EveryoneTest extends AbstractJCRTest {
    ...
    public void testEveryoneName() throws RepositoryException {
        ...
        String expectedName = null; // TODO type the expected authorizable name using constants defined by oak.
    ...
    public void testAccessByName() throws RepositoryException {
        ...
        Principal everyoneByName = null; // TODO: retrieve the everyone principal by name
    ...
    public void testEveryoneIsMemberofEveryone() throws RepositoryException {
        ...
        // TODO: discuss the dynamic nature of the everyone group principal
        while (it.hasNext()) {
    ...
    public void testEveryoneAsAuthorizableGroup() throws RepositoryException {
        // TODO: create an authorizable that corresponds to the everyone principal.
        ...
        try {
            ...
            // TODO: verify that the everyone principal is still a dynamic group
            // TODO: test if the dyanmic nature also applies to the authorizable
        } finally {
