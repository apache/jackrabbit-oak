 ...
 * -----------------------------------------------------------------------------
 *
 * - {@link org.apache.jackrabbit.oak.security.authorization.accesscontrol.AccessControlListTest}
 * - {@link org.apache.jackrabbit.oak.security.authorization.accesscontrol.EffectivePoliciesTest}
 ...
 */
public class AccessControlManagerTest extends AbstractJCRTest {
    ...
    public void testGetAccessControlManager() throws RepositoryException {
        ...
        // TODO retrieve the access control manager using standard JCR API
        AccessControlManager acMgr = null;
        assertNotNull(acMgr);

        // TODO retrieve the jackrabbit access control manager using standard API, without risking a class-cast exception.
    ...
    public void testRetrievePoliciesAtTestRoot() throws RepositoryException {
        ...
        assertEquals(acl, acl2); // TODO: is this correct?
    }
    ...
    public void testAddAceWithUtility() throws RepositoryException {
        ...
        boolean expectedSuccess = false; // TODO
        ...
        // TODO: is the following expected to succeed?
        assertEquals(acl, acl2);

        int expectedAceLength = -1; // TODO
    ...
    public void testRetrievePoliciesAsReadOnlySession() throws RepositoryException {
        ...
        try {
            AccessControlPolicyIterator policyIterator = readOnly.getAccessControlManager().getApplicablePolicies(testRoot);
            AccessControlPolicy[] policies = readOnly.getAccessControlManager().getPolicies(testRoot);
        } finally {
            if (readOnly.isLive()) {
                readOnly.logout();
            }
    ...
    public void testWritePoliciesAsReadOnlySession() throws RepositoryException {
        ...
        try {
            ...
            readOnly.getAccessControlManager().setPolicy(testRoot, acl);
        } finally {
            if (readOnly.isLive()) {
                readOnly.logout();
            }
