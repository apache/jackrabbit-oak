 ...
 */
public class LL4_RepositoryWithoutAnonymousTest extends AbstractSecurityTest {

    @Override
    protected ConfigurationParameters getSecurityConfigParameters() {
        // TODO : use the built-in oak configuration settings to prevent anonymous access altogether
        ConfigurationParameters userConfig = ConfigurationParameters.EMPTY; // FIXME
