...
public class L2_PrincipalManagerTest extends AbstractJCRTest {
    ...
    private String getNonExistingPrincipalName() {
        // TODO: return a non existing principal name (Q: what could you do instead of guessing?)
        return null;
    }
    ...
    public void testFindPrincipals() throws RepositoryException {
        String searchHint = testPrincipalName;             // TODO: play with the search hint
        int searchType = PrincipalManager.SEARCH_TYPE_ALL; // TODO: modify the type flag

        PrincipalIterator principalIterator = principalManager.findPrincipals(testPrincipalName, searchType);

        // TODO: what is the expected query result depending on the search hint and the type-flag?
    }
    ...
    public void testGetGroupMembership() throws RepositoryException {
        ...
        // TODO: what group principals do you expect here?
    }
