...
public class L7_ImpersonationTest extends AbstractJCRTest {
    ...
    public void testImpersonateTestUser() throws RepositoryException {
        Principal principal = null; // TODO: fill in the correct principal such that the test passes.
    ...
    public void testImpersonateOneSelf() throws RepositoryException {
        // TODO: walk through this impersonation. does it work? if it does: why?
    ...
    public void testAdvancedImpersonationTest() throws RepositoryException {
        // TODO: change the permission setup such that the test-user is allowed to make himself an impersonator of 'another' user.
        ...
        // TODO: change the impersonation of 'anotherUser' again such that the impersonate call fails
        // TODO: withouth changing the permission setup. what API calls do you have at hand?
