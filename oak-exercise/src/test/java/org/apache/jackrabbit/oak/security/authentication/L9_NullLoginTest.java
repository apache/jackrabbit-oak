...
public class L9_NullLoginTest extends AbstractJCRTest {
    ...
    public void testNullLogin() throws RepositoryException {
        try {
            ...
            // success
            // TODO: explain what is going on and why it is expected to fail.
        }
    }

    public void testSuccessfulNullLogin() throws Exception {
        // TODO: populate a subject that results in successful null-login
        Subject subject = null; // FIXME: create a valid subject
        String expectedId = null; // FIXME
