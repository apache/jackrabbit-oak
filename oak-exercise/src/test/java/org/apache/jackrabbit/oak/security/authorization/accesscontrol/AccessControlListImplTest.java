 ...
 * </pre>
 */
public class AccessControlListImplTest extends AbstractJCRTest {
    ...
    public void testUpdateAndComplementary() throws Exception {
        ...
        Privilege[] expectedPrivileges = null; // TODO
        assertArrayEquals(expectedPrivileges, entries[0].getPrivileges());

        Privilege[] expectedPrivileges1 = null; // TODO
    ...
    public void testAddEntryWithInvalidPrincipals() throws Exception {
        // TODO: explain for each principal in the list why using it for an ACE fails
    ...
    public void testAddEntryWithInvalidPrivilege() throws Exception {
        ...
        // TODO : walks through this test and explain why adding those ACEs fails.
    ...
    public void testRemoveInvalidEntry() throws RepositoryException {
        ...
        // TODO : walk through the removal and explain the expected behaviour.
        try {
