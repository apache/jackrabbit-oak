 ...
 * -----------------------------------------------------------------------------
 *
 * - {@link org.apache.jackrabbit.oak.security.authentication.AuthInfoTest}
 *
 * </pre>
 *
 ...
 */
public class UserIDTest extends AbstractJCRTest {
    ...
    public void testGetUserIDReturnsNull() throws RepositoryException, LoginException {
        ...
        try {
            ...
            // TODO : explain why the userID of the admin-session is now 'null'
