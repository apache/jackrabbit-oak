 ...
 * -----------------------------------------------------------------------------
 *
 * - {@link org.apache.jackrabbit.oak.security.user.RemovalAndMembershipTest()}
 *
 * </pre>
 *
 */
public class RemoveAuthorizableTest extends AbstractJCRTest {
    ...
    public void testAccessControlEntry() throws RepositoryException, NotExecutableException {
        ...
        // TODO: do you expect the ACE for test-principal to be still present? explain why and fix the test if necessary.
        assertTrue(found);
    }
    ...
    public void testCreatedBy() throws RepositoryException {
        ...
        // TODO: explain why the folder node must have a jcr:created property.
        ...
        // TODO: do you expect jcr:createdBy property to be still present? explain why and fix the test if necessary.
        assertTrue(folder.hasProperty(NodeTypeConstants.JCR_CREATEDBY));
    }
    ...
    public void testLastModifiedBy() throws RepositoryException {
        ...
        // TODO: do you expect the property to be still present? explain why and fix the test if necessary.
        assertTrue(testNode.hasProperty(NodeTypeConstants.JCR_LASTMODIFIEDBY));
    }
