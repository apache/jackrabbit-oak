...
public class L13_SystemUserTest extends AbstractSecurityTest {
    ...
    public void testSystemUser() throws RepositoryException {
        ...
        Boolean isGroup = null; // TODO
        assertEquals(isGroup.booleanValue(), authorizable.isGroup());

        Boolean isAdmin = null; // TODO
        assertEquals(isAdmin.booleanValue(), systemUser.isAdmin());

        // TODO: retrieve the authorizable by class: what is the correct authorizble-class to use?
        Class cls = null;
    ...
    public void testSystemUserPrincipal() throws RepositoryException {
        ...
        // TODO: what is the nature of the principal of the system user? Assert your expectedation.
        ...
        List<Principal> expectedGroupPrincipals = null; // TODO
        while (pIter.hasNext()) {
