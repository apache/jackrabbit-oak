...
public class L7_AccessControlContentTest extends AbstractJCRTest {
    ...
    public void testAclContent() throws RepositoryException {
        ...
        // TODO retrieve the policy node and verify the expected name, primary type and child items
        ...
        // TODO verify the correct number + expected nature of the children.
    }
    ...
    public void testAceContent() throws RepositoryException {
        ...
        String expectedPrimaryTypeName = null; // TODO: define the type of the first child node.
        while (aclChildren.hasNext()) {
            ...
            expectedPrimaryTypeName = null; // TODO: define the type of the next item.
        }

        Node ace = aclNode.getNodes().nextNode();
        // TODO: retrieve all mandatory ac-related properties of this node and verify the expected value.
    }
    ...
    public void testRestrictionContent() throws RepositoryException {
        ...
        Node ace = aclNode.getNodes().nextNode();
        // TODO: retrieve the restrictions defined for the single ACE node
        // TODO: verify the expected properties and their value(s)
    }
    ...
    public void testRepoPolicy() throws RepositoryException {
        ...
        // TODO: can you also identify which mixins are being involved and where they got applied?
    }
}
