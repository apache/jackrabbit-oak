 ...
 * - {@link org.apache.jackrabbit.oak.security.user.LL4_RepositoryWithoutAnonymousTest ()}
...
public class L4_GuestLoginTest extends AbstractJCRTest {
    ...
    public void testAnonymousSimpleCredentialsLoginSuccess() throws RepositoryException {
        ...
        // TODO: how to you need to modify the test-case that this would work?
        // FIXME: add fix here
    ...
    public void testDisableGuestLogin() throws RepositoryException {
        ...
        // TODO : identify ways to prevent anonymous login with GuestCredentials in an existing repository
        // FIXME : extend the test here such that the login below fails
        // 1:
        // 2:
