...
public class L5_CustomPrivilegeTest extends AbstractSecurityTest {
    ...
    public void testCustomPrivilege() {
        ...
        Boolean expectedIsAbstract = null; // TODO
        assertEquals(expectedIsAbstract.booleanValue(), customAggrPriv.isAbstract());
    }

    @Test
    public void testJcrAll() {
        // TODO : verify that the custom privileges are contained in the jcr:all aggregation
    }

    @Test
    public void testHasPrivilege() throws Exception {
        try {
            // TODO : fix the test case such that the test principals have the specified privileges granted at "/"
