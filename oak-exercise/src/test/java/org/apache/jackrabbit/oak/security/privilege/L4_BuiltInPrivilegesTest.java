...
public class L4_BuiltInPrivilegesTest extends AbstractSecurityTest {
    ...
    public void testAggregation() throws RepositoryException {
        ...
        // TODO: for all aggregated privileges define the mapping of the privilege name to declaredAggregates
    ...
    public void testMapItems() throws Exception {
        ...
        for (Privilege privilege : jcrAll.getAggregatePrivileges()) {
            try {
                // TODO : modify item(s) affected by the given privilege and verify that it fails

                setupAcl(privilege, acMgr);
                testRoot.refresh();

                // TODO : modify the same item(s) again and verify that it succeeds
