...
/**
 * Test S3DataStore operation with SSE_KMS encryption. It requires to pass aws config file via
 * system property  or system properties by prefixing with 'ds.'. See details @
 * {@link S3DataStoreUtils}. For e.g. -Dconfig=/opt/cq/aws.properties. Sample aws properties located
 * at src/test/resources/aws.properties provide kmsKeyId in above aws.properties file
 */
