...
public interface S3DataStoreStatsMBean {
    ...
    /**
     * Obtains the number of records that are in the process of being "synced", meaning they are
     * either scheduled to be copied to S3 or are actively being copied to S3 but the copy of these
     * files has not yet completed.
     *
