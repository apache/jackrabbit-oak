...
/**
 * A Solr configuration holding all the possible customizable parameters that can be leveraged for
 * an Oak search index.
 */
public interface OakSolrConfiguration {
     ...
     * {@link org.apache.jackrabbit.oak.api.Type}
     *
     * @param propertyType the {@link org.apache.jackrabbit.oak.api.Type} to be indexed / searched
     * @return the name of the Solr field to be used for the given
     * {@link org.apache.jackrabbit.oak.api.Type}, or {@code null} if no specific field has been
     * configured to handle the given {@code Type}.
     */
    @Nullable
     ...
     *
     * @return the name of the Solr field to be used for indexing and searching on paths (exact
     * matching).
     */
    @NotNull
    String getPathField();
     ...
     * {@link org.apache.jackrabbit.oak.spi.query.Filter.PathRestriction}
     *
     * @param pathRestriction the {@link org.apache.jackrabbit.oak.spi.query.Filter.PathRestriction}
     *                        used for filtering search results or {@code null} if no specific field
    ...
    /**
     * Provide a field name to search over for the given
     * {@link org.apache.jackrabbit.oak.spi.query.Filter.PropertyRestriction}
     *
     * @param propertyRestriction the
     *                            {@link
     *                            org.apache.jackrabbit.oak.spi.query.Filter.PropertyRestriction}
     *                            used for filtering search results
     * @return the name of the Solr field to be used for the given {@code PropertyRestriction} or
     * {@code null} if no specific field has been configured for it.
     */
    @Nullable
    ...
    /**
     * Provide a field name that is used as the default "catch all" field for searching over all the
     * data
     *
     * @return the name of the Solr field to be used as "catch all" field, or {@code null} if no
     * specific field has been configured for it.
     */
    @Nullable
     ...
     * {@link org.apache.jackrabbit.oak.plugins.index.solr.query.SolrQueryIndex} should be used for
     * {@link org.apache.jackrabbit.oak.spi.query.Filter.PropertyRestriction}s
     */
     ...
     * @return <code>true</code> if
     * {@link org.apache.jackrabbit.oak.plugins.index.solr.query.SolrQueryIndex} should be used for
     * filtering by {@link org.apache.jackrabbit.oak.spi.query.Filter.PathRestriction}s
     */
    boolean useForPathRestrictions();

    /**
     * Provide the names of the properties that should be neither indexed nor searched by the Solr
     * index
     *
    ...
    /**
     * Make all nodes / documents matching a query that are descendants of a 'jcr:content' node
     * collapse into such a node. That will result in resultsets being tipically much more compact
     * in cases where most / all of the matching nodes match such a hierarchy.
     *
     * @return {@code true} if only the 'jcr:content' node should be returned for all its the
     * matching descendants, {@code false} otherwise
     */
    boolean collapseJcrContentNodes();

    /**
     * Make all nodes / documents matching a query having name equals to 'jcr:content' collapse into
     ...
     * {@link #collapseJcrContentNodes()} is set to {@code true}.
     *
    ...
    /**
     * Provide the name of the field containing information about the depth of a certain path /
     * node
     *
