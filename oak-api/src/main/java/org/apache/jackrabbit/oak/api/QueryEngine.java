...
public interface QueryEngine {
    ...
    /**
     * The suffix for internal SQL-2 statements. Those are logged with trace level instead of debug
     * level.
     */
     ...
     * {@link #executeQuery(String, String, long, long, Map, Map)} when there are no variables in a
     * query.
     */
     ...
     * {@link #executeQuery(String, String, long, long, Map, Map)} when there are no local namespace
     * mappings.
     */
