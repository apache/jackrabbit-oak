...
public interface PropertyValue extends Comparable<PropertyValue> {
    ...
    /**
     * Value of this object. The type of the return value is determined by the target {@code type}
     ...
     * the value to the target type. If the conversion fails an exception is thrown.
     *
