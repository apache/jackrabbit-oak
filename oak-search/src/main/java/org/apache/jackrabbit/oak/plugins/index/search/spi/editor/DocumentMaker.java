 ...
 * For Apache Lucene that would be a Lucene {@code Document}, for Apache Solr that might be a
 * {@code SolrInputDocument}, etc.
 */
public interface DocumentMaker<D> {
     ...
     */
    D makeDocument(NodeState state, boolean isUpdate, List<PropertyState> propertiesModified)
        throws IOException;
