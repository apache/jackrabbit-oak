...
public class IncreasedMaxBackOffMillisConcurrentOakClusterTest {
    ...
    public void twoCluster50Threads() throws Exception {
        ...
        await().pollInterval(5, SECONDS).atMost(20, MINUTES).until(new Callable<Boolean>() {
            @Override
            public Boolean call() throws Exception {
                ...
                return !from(writers).anyMatch(IS_ALIVE);
            }
        });

        // then
        await().pollInterval(5, SECONDS).atMost(1, MINUTES).until(new Callable<Boolean>() {
            @Override
            public Boolean call() throws Exception {
                ...
                return size == concurrentWriters * numberOfWriteAttempts;
            }
        });
