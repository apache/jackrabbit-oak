...
public class GlobsPatternTest {
    ...
    public void testAllMatching() {
        ...
        MATCH.values()
             .forEach(testPaths -> testPaths.forEach(testPath -> assertTrue(gp.matches(testPath))));
    }
    ...
    public void testMatchTreeProperty() {
        ...
        MATCH.get(rest2).forEach(testPath -> {
            ...
            PropertyState ps = when(mock(PropertyState.class).getName()).thenReturn(
                PathUtils.getName(testPath)).getMock();
    ...
    public void testHashCode() {
        ...
        assertNotEquals(pattern.hashCode(),
            new GlobsPattern(PATH, Collections.emptyList()).hashCode());
        assertNotEquals(pattern.hashCode(),
            new GlobsPattern(PATH, Collections.singletonList(rest2)).hashCode());
    ...
    public void testNotEquals() {
        ...
        assertNotEquals(pattern,
            new GlobsPattern(PATH, Arrays.asList(rest1, rest2, getAnyRestriction(NO_MATCH))));
        // different restriction
        assertNotEquals(new GlobsPattern(PATH, Collections.singletonList(rest1)),
            GlobPattern.create(PATH, rest1));
    }
}
