...
public class IndexDisablerTest {
    ...
    public void disableIndexes() throws Exception {
        ...
        assertEquals(TYPE_DISABLED,
            rootBuilder.getChildNode("oak:index").getChildNode("fooIndex")
    ...
    /**
     * Test that indexes are not disabled in same cycle as when reindexing is done
     */
    @Test
    ...
    public void nodeTypeIndexDisabling_typeExist() throws Exception {
        ...
        PropertyState declaringNodeType = rootBuilder.getChildNode(INDEX_DEFINITIONS_NAME)
                                                     ...
                                                     .getProperty(DECLARING_NODE_TYPES);
    ...
    public void indexToBeDisabled_PathExists() throws Exception {
        rootBuilder.child("oak:index").child("fooIndex")
                   .setProperty(TYPE_PROPERTY_NAME, "property");
        recreateDisabler();
