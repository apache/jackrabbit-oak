...
public class ContentMirrorStoreStrategyTest {
    ...
    public void nonRootStorage() throws Exception{
        ...
        assertThat(CollectionUtils.toImmutableList(paths), containsInAnyOrder("a", "a/c", "b"));
        ...
        assertThat(CollectionUtils.toImmutableList(paths), containsInAnyOrder("a", "a/c"));
        ...
        assertThat(CollectionUtils.toImmutableList(paths), containsInAnyOrder("/content/a", "/content/a/c", "/content/b"));

        paths = store.query(filter2, null, indexMeta.getNodeState(), KEY);
        assertThat(CollectionUtils.toImmutableList(paths), containsInAnyOrder("/content/a", "/content/a/c"));
    }
