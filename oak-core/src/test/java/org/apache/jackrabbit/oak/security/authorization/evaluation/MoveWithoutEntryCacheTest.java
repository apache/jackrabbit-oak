...
public class MoveWithoutEntryCacheTest extends AbstractOakCoreTest {
    ...
    protected ConfigurationParameters getSecurityConfigParameters() {
        ...
        authConf.put("eagerCacheSize", 0);
        Properties secConf = new Properties();
        secConf.put(AuthorizationConfiguration.NAME, ConfigurationParameters.of(authConf));
        return ConfigurationParameters.of(secConf);
    }
