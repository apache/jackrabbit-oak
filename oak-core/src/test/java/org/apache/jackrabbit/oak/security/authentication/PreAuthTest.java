...
public class PreAuthTest extends AbstractSecurityTest {
    ...
    public void testValidSubject() throws Exception {
        ...
        ContentSession cs = Java23Compatability.doAsPrivileged(subject, new PrivilegedAction<ContentSession>() {
            @Override
    ...
    public void testSystemSubject() throws Exception {
        ContentSession cs = Java23Compatability.doAsPrivileged(SystemSubject.INSTANCE, new PrivilegedAction<ContentSession>() {
            @Override
            public @Nullable ContentSession run() {
                try {
                    return login(null);
