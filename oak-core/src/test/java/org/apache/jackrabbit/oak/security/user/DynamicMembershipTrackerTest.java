...
public class DynamicMembershipTrackerTest extends AbstractSecurityTest {
    ...
    public void testNoServiceRegistered() {
        DynamicMembershipProvider dmp = dynamicMembership.getDynamicMembershipProvider(root,
    ...
    public void testServiceWithDefaultProvider() {
        ...
        registrations.add(context.bundleContext()
                                 .registerService(DynamicMembershipService.class.getName(), dms,
    ...
    public void testServiceWithCustomProvider() throws Exception {
        ...
        DynamicMembershipProvider provider = dynamicMembership.getDynamicMembershipProvider(root,
            getUserManager(root), getNamePathMapper());
