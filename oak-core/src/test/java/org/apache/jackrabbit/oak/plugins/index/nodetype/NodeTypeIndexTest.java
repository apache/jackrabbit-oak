...
public class NodeTypeIndexTest {
    ...
    private NodeStore store = new MemoryNodeStore(INITIAL_CONTENT);
    ...
    /**
     * Same rationale as PropertyIndex#getMinimumCost -- see
     * PropertyIndexTest#getMinimumCostIsAlwaysCostOverhead.
     */
    @Test
    public void getMinimumCostIsAlwaysLegacyValue() {
        assertEquals(NodeTypeIndexLookup.MINIMUM_COST,
                new NodeTypeIndex(Mounts.defaultMountInfoProvider()).getMinimumCost(), 0.0);
        assertEquals(NodeTypeIndexLookup.MINIMUM_COST,
                new NodeTypeIndex(Mounts.defaultMountInfoProvider(), true).getMinimumCost(), 0.0);
    }
