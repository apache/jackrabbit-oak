...
public class IndexImporterTest {
    ...
    public void importData_IncrementalUpdate() throws Exception{
        ...
        assertNull(store.getRoot().getChildNode("oak:index").getChildNode("fooIndex").getProperty(IndexImporter.indexImportStateKey));
    }
    ...
    private String importData_IncrementalUpdate_Before_Setup_Method() throws IOException, CommitFailedException {
        NodeBuilder builder = store.getRoot().builder();
        createIndexDefinition(builder.child(INDEX_DEFINITIONS_NAME),
                "fooIndex", true, false, ImmutableSet.of("foo"), null)
                .setProperty(ASYNC_PROPERTY_NAME, "async");
    ...
    @Test
    public void importData_IncrementalUpdate_Test_Failure_AT_SWITCHLANE_State() throws Exception {
    ...
    @Test
    public void importData_IncrementalUpdate_Test_Failure_AT_importIndexData_State() throws Exception {
        String checkpoint = importData_IncrementalUpdate_Before_Setup_Method();
        try {
            IndexImporter importer = new IndexImporter(store, temporaryFolder.getRoot(), provider, NOOP_LOCK) {
                @Override
