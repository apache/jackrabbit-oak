...
public class OakFongo extends Fongo {
    ...
    private class OakFongoDBCollection extends FongoDBCollection {
        ...
        BulkWriteResult executeBulkWriteOperation(boolean ordered,
                                                  ...
                                                  WriteConcern aWriteConcern,
                                                  DBEncoder encoder) {
            beforeExecuteBulkWriteOperation(ordered, bypassDocumentValidation, requests, aWriteConcern);
            BulkWriteResult result = super.executeBulkWriteOperation(ordered, bypassDocumentValidation, requests, aWriteConcern, encoder);
