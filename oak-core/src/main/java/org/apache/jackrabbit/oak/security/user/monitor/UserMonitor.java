...
public interface UserMonitor extends Monitor<UserMonitor> {
     ...
     * @param declaredOnly   {@code true} if only declared members were retrieved; {@code false} if
     *                       declared and inherited members were retrieved.
     */
     ...
     *
     * @param timeTakenNanos The time in nanoseconds
     * @param declaredOnly   {@code true} if only declared membership was retrieved; {@code false}
     *                       otherwise.
     */
     ...
     */
    default void doneUpdateMembers(long timeTakenNanos, long totalProcessed, long failed,
        boolean isRemove) {
    }
