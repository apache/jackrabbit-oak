...
public final class TagsPredicate implements Predicate<JsonObject> {

    private static final Logger LOG = LoggerFactory.getLogger(TagsPredicate.class);

    private final Set<String> tags;

    public TagsPredicate(final Set<String> tags) {
        this.tags = tags;
    }
