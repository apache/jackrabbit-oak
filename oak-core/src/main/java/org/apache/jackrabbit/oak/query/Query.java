 ...
 * <p>
 * Lifecycle: use the constructor to create a new object. Call init() to initialize the bind
 * variable map. If the query is re-executed, a new instance is created.
 */
@ProviderType
public interface Query {
    ...
    /**
     * Initialize the query. This will 'wire' selectors into constraints, and collect bind variable
     * names. It will also simplify expressions if possible, but will not prepare the query.
     */
    void init();
    ...
    /**
     * Try to convert the query to an alternative form, specially a "union". To avoid any potential
     * error due to state variables perform the conversion before the {@link #init()}.
     *
     * @return {@code this} if no conversions are possible or a new instance of a {@link Query}.
     * Cannot return null.
     */
    @NotNull
     ...
     *
     * @throws IllegalArgumentException if potentially slow, and configured to fail in this case
     */
