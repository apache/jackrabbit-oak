...
public class EventEditorProvider implements IndexEditorProvider {
    ...
    public Editor getIndexEditor(@NotNull String type,
        ...
        EventIndex index = new EventIndex(definition, callback);
        return new EventEditor(index, null, null);
    }
}    
