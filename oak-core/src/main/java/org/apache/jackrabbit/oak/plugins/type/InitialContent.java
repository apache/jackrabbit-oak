...
public class InitialContent extends DefaultMicroKernelTracker {
    ...
    public void available(MicroKernel mk) {
        ...
        if (!root.hasChildNode("oak:index")) {
            ...
            mk.commit("/", "+\"oak:index\":{\"jcr:uuid\":{\"jcr:primaryType\":\"nam:nt:queryIndexDefinition\", \"type\":\"property\", \"unique\":true},\"rep:authorizableId\":{\"jcr:primaryType\":\"nam:nt:queryIndexDefinition\", \"type\":\"property\",\"unique\":true},\"rep:principalName\":{\"jcr:primaryType\":\"nam:nt:queryIndexDefinition\", \"type\":\"property\",\"unique\":true}}", null, null);
        }
