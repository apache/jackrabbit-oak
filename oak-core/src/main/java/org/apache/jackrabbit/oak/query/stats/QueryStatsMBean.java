...
public interface QueryStatsMBean {
    ...
    /**
     * Get the slow queries. Those are the ones that scan more than 100'000 nodes, or the configured
     * maximum number of nodes to scan. (Raw execution time is not taken into account, as execution
     * can be slow if the code is not compiled yet.)
     *
    ...
    /**
     * Whether to capture a thread dump in addition to the thread name. No thread name / thread dump
     * is captures for internal queries.
     *
