...
public interface PropertyIndexStatsMBean {
    ...
    @Description(
        "Determines statistics related to specific property index which can be used to optimize property index "
            +
    ...
    @Description(
        "Determines statistics related to property index for all property index under given path. Various limits "
            +
