...
/**
 * {@code EventTypeFilter} filters based on event types as defined by
...
public class EventTypeFilter implements EventFilter {
    ...
    /**
     * Create a new {@code Filter} instance that includes all events matching the {@code eventTypes}
     * bit mask. That is, a given event is included if the corresponding bit in {@code eventType} is
     * set.
     *
