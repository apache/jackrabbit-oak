...
/**
 * {@code NodeStore}-based implementation of the {@link ContentRepository} interface.
 */
public class ContentRepositoryImpl implements ContentRepository, Closeable {
     ...
     * @param classicMove          optional feature flag to use classic move implementation.
     */
    public ContentRepositoryImpl(@NotNull NodeStore nodeStore,
        ...
        this.queryEngineSettings =
            queryEngineSettings != null ? queryEngineSettings : new QueryEngineSettings();
        this.indexProvider =
            indexProvider != null ? indexProvider : new CompositeQueryIndexProvider();
    ...
    public ContentSession login(Credentials credentials, String workspaceName)
        ...
        LoginContextProvider lcProvider = securityProvider.getConfiguration(
            AuthenticationConfiguration.class).getLoginContextProvider(this);
    ...
    protected GenericDescriptors createDescriptors() {
        ...
        GenericDescriptors gd = new GenericDescriptors(baseDescriptors)
            .put(IDENTIFIER_STABILITY,
                valueFactory.createValue(Repository.IDENTIFIER_STABILITY_METHOD_DURATION), true,
                true)
            ...
            .put(NODE_TYPE_MANAGEMENT_INHERITANCE,
            ...
            .put(REP_VENDOR_DESC, valueFactory.createValue("The Apache Software Foundation"), true,
                true)
            .put(REP_VENDOR_URL_DESC, valueFactory.createValue("http://www.apache.org/"), true,
                true)
            .put(SPEC_NAME_DESC,
        ...
        for (SecurityConfiguration sc : securityProvider.getConfigurations()) {
            ...
            if (UserConfiguration.NAME.equals(name)) {
                gd.put(JackrabbitRepository.OPTION_USER_MANAGEMENT_SUPPORTED, trueValue, true,
                    false);
            } else if (PrincipalConfiguration.NAME.equals(name)) {
                gd.put(JackrabbitRepository.OPTION_PRINCIPAL_MANAGEMENT_SUPPORTED, trueValue, true,
                    false);
            } else if (PrivilegeConfiguration.NAME.equals(name)) {
                gd.put(JackrabbitRepository.OPTION_PRIVILEGE_MANAGEMENT_SUPPORTED, trueValue, true,
                    false);
            }
        }
        return gd;
