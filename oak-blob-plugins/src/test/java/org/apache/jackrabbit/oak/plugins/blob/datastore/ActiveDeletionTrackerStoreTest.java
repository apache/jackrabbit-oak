...
public class ActiveDeletionTrackerStoreTest {
    ...
    public void filter() throws Exception {
        ...
        assertTrue("More elements after filtering", toList(filtered).isEmpty());
    }
    ...
    public void noFilter() throws Exception {
        ...
        assertEquals("Incorrect elements after filtering", range(0, 4), toList(filtered));
    }
