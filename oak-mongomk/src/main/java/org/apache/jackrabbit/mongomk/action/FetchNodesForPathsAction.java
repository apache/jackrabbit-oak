...
/**
 * An action for fetching nodes under certain paths.
 */
public class FetchNodesForPathsAction extends AbstractAction<List<NodeMongo>> {

    private static final Logger LOG = LoggerFactory.getLogger(FetchNodesForPathsAction.class);
    ...
    /**
     * Constructs a new {@code FetchNodesForPathsAction}.
     *
     ...
     * @param branchId
     */
    public FetchNodesForPathsAction(MongoConnection mongoConnection,
