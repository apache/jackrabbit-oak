...
<ol>
    ...
    <li>
        ...
        <a href="<%= Text.encodeIllegalXMLCharacters(request.getContextPath()) %>/repository/default/">default
            workspace</a>
...
<p>
    ...
    a <em><%= Text.encodeIllegalXMLCharacters(application.getServerInfo()) %>
