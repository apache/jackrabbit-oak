...
public class ProtectionConfigTrackerTest extends AbstractProtectionConfigTest {
    ...
    public void testNoServices() {
        ...
        assertEquals(ProtectionConfig.DEFAULT.isProtectedProperty(tree, property),
            tracker.isProtectedProperty(tree, property));
    ...
    public void testIsProtectedTreeRegisteredServices() {
        ...
        context.registerService(ProtectionConfig.class, new TestProtectionConfig("protected"),
    ...
    public void testIsProtectedPropertyRegisteredServices() {
        ...
        context.registerService(ProtectionConfig.class, new TestProtectionConfig("protected1"),
            Collections.emptyMap());
        context.registerService(ProtectionConfig.class, new TestProtectionConfig("protected2"),
            Collections.emptyMap());
