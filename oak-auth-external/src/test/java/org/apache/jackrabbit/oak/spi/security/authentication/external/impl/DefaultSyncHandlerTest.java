...
public class DefaultSyncHandlerTest extends ExternalLoginTestBase {
    ...
    public void testSyncMembershipCaseMismatch() throws Exception {
        ...
        user.setProperty(DefaultSyncContext.REP_EXTERNAL_ID, getValueFactory().createValue("thirduser;test"));
        Group group = userManager.createGroup("thirdgroup");
        group.setProperty(DefaultSyncContext.REP_EXTERNAL_ID, getValueFactory().createValue("thirdgroup;test"));
