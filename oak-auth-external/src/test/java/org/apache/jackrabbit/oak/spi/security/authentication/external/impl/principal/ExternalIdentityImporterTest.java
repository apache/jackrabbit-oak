...
/**
 * Test XML import of external users/groups with protection of external identity properties turned
 * on.
 */
public class ExternalIdentityImporterTest {
    ...
    public static final String XML_EXTERNAL_USER_WITH_PRINCIPAL_NAMES =
    ...
    private Repository createRepo() {
        SecurityProvider securityProvider = TestSecurityProvider.newTestSecurityProvider(
    ...
    Session createSession(Repository repo, boolean isSystem) throws Exception {
        if (isSystem) {
            ...
            return repo.login(new SimpleCredentials(UserConstants.DEFAULT_ADMIN_ID,
    ...
    static void assertHasProperties(@NotNull Node node, @NotNull String... propertyNames)
        throws Exception {
    ...
    static void assertNotHasProperties(@NotNull Node node, @NotNull String... propertyNames)
        throws Exception {
        for (String pN : propertyNames) {
