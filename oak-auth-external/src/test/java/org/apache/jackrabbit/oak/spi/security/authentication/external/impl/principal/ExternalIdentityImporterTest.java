...
public class ExternalIdentityImporterTest {
    ...
    public static final String XML_EXTERNAL_GROUP = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
            ...
            "   <sv:property sv:name=\"rep:principalName\" sv:type=\"String\"><sv:value>g1Princ</sv:value></sv:property>" +
            "   <sv:property sv:name=\"rep:externalId\" sv:type=\"String\"><sv:value>idp;ext-g1</sv:value></sv:property>" +
            "   <sv:property sv:name=\"rep:lastSynced\" sv:type=\"Date\"><sv:value>2016-05-03T10:03:08.061+02:00</sv:value></sv:property>" +
            "</sv:node>";
    ...
    @Test
    public void importExternalGroup() throws Exception {
        Node parent = doImport(createSession(false), UserConstants.DEFAULT_USER_PATH, XML_EXTERNAL_GROUP);
        assertHasProperties(parent.getNode("g"), ExternalIdentityConstants.REP_EXTERNAL_ID, ExternalIdentityConstants.REP_LAST_SYNCED);
    }

    @Test
    public void importExternalGroupAsSystem() throws Exception {
        Node parent = doImport(createSession(true), UserConstants.DEFAULT_USER_PATH, XML_EXTERNAL_GROUP);
        assertHasProperties(parent.getNode("g"), ExternalIdentityConstants.REP_EXTERNAL_ID, ExternalIdentityConstants.REP_LAST_SYNCED);
    }
}