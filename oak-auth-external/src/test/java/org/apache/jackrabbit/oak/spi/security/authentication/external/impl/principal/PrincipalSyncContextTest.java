...
public class PrincipalSyncContextTest extends AbstractExternalAuthTest {

    private Root r;
    private UserManager userManager;
    private ValueFactory valueFactory;

    private PrincipalSyncContext syncContext;
    ...
    public void before() throws Exception {
        ...
        syncContext = new PrincipalSyncContext(syncConfig, idp, userManager, valueFactory);
    }
    ...
    public void testSyncExternalGroupExisting() throws Exception {
        ...
        // synchronizing using PrincipalSyncContext must update the existing group
        syncContext.setForceGroupSync(true);
