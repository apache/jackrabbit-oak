...
class ExternalIdentityValidatorProvider extends ValidatorProvider implements ExternalIdentityConstants {
    ...
    private static final Logger log = LoggerFactory.getLogger(ExternalIdentityValidatorProvider.class);
    ...
    private void checkRemoveProperties(@Nonnull NodeState parent, @Nonnull String name, @Nonnull PropertyState propertyState) throws CommitFailedException {
    ...
    private final class ExternalIdentityValidator extends DefaultValidator {
        ...
        public void propertyDeleted(PropertyState before) throws CommitFailedException {
            checkRemoveProperties(parent, before.getName(), before);
        }
