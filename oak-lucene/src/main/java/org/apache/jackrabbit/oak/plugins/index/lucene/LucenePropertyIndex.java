            ...
            private boolean loadDocs() {
                ...
                try {
                    ...
                    if (luceneRequestFacade.getLuceneRequest() instanceof Query) {
                        ...
                        QueryParser qp = new QueryParser(Version.LUCENE_48, aclCheckField, indexNode.getDefinition().getAnalyzer());
                        ...
                        QueryParser qp = new QueryParser(Version.LUCENE_48, FieldNames.SUGGEST,
