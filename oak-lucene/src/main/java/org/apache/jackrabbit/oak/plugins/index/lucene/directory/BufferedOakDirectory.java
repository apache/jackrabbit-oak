...
public final class BufferedOakDirectory extends Directory {
    ...
    public BufferedOakDirectory(@Nonnull NodeBuilder builder,
        ...
        this.base = new OakDirectory(checkNotNull(builder), definition, false, blobFactory);
        reopenBuffered();
    }

    @Override
    public String[] listAll() throws IOException {
        LOG.debug("[{}]listAll()", getIndexPath());
    ...
    public boolean fileExists(String name) throws IOException {
        LOG.debug("[{}]fileExists({})", getIndexPath(), name);
    ...
    public void deleteFile(String name) throws IOException {
        LOG.debug("[{}]deleteFile({})", getIndexPath(), name);
    ...
    public long fileLength(String name) throws IOException {
        LOG.debug("[{}]fileLength({})", getIndexPath(), name);
        if (bufferedForDelete.contains(name)) {
    ...
    public IndexOutput createOutput(String name, IOContext context)
            throws IOException {
        LOG.debug("[{}]createOutput({})", getIndexPath(), name);
    ...
    public void sync(Collection<String> names) throws IOException {
        LOG.debug("[{}]sync({})", getIndexPath(), names);
        buffered.sync(names);
        base.sync(names);
    }
    ...
    public IndexInput openInput(String name, IOContext context)
            throws IOException {
        LOG.debug("[{}]openInput({})", getIndexPath(), name);
        if (bufferedForDelete.contains(name)) {
            String msg = String.format("already deleted: [%s] %s",
                    getIndexPath(), name);
            throw new FileNotFoundException(msg);
    ...
    private void reopenBuffered() {
        ...
        buffered = new OakDirectory(bufferedBuilder, definition, false, blobFactory);
    }
