 ...
 * case it is returned with search hits on the document.  Thus each document should typically
 * contain one or more stored fields which uniquely identify it.
 *
 * <p>Note that fields which are <i>not</i>
 * {@link org.apache.lucene.index.IndexableFieldType#stored() stored} are
...
public final class Document implements Iterable<IndexableField> {
     ...
     * index, e.g. {@link IndexSearcher#doc(int)} or {@link IndexReader#document(int)}.
     */
     ...
     * returns an empty array when there are no matching fields.  It never returns null. For
     * {@link IntField}, {@link LongField}, {@link FloatField} and {@link DoubleField} it returns
     * the string value of the number. If you want the actual numeric field instances back, use
     * {@link #getFields}.
     *
     * @param name the name of the field
     ...
     * only binary fields with this name exist, returns null. For {@link IntField},
     * {@link LongField}, {@link FloatField} and {@link DoubleField} it returns the string value of
     * the number. If you want the actual numeric field instance back, use {@link #getField}.
     */
