...
public class FieldType implements IndexableFieldType {
    ...
    /**
     * Set to <code>true</code> if this field's indexed form should be also stored into term
     * vectors.
     *
    ...
    /**
     * NumericType: if non-null then the field's value will be indexed numerically so that
     * {@link NumericRangeQuery} can be used at search time.
     * <p>
    ...
    public void setNumericPrecisionStep(int precisionStep) {
        ...
        if (precisionStep < 1) {
            throw new IllegalArgumentException(
                "precisionStep must be >= 1 (got " + precisionStep + ")");
        }
