 ...
 * <p>
 * The values are stored directly with no sharing, which is a good fit when the fields don't share
 * (many) values, such as a title field.  If values may be shared and sorted it's better to use
