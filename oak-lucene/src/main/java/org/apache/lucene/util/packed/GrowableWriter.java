...
public class GrowableWriter extends PackedInts.Mutable {
    ...
    /**
     * @param startBitsPerValue       the initial number of bits per value, may grow depending on
     *                                the data
    ...
    private void ensureCapacity(long value) {
        ...
        PackedInts.Mutable next = PackedInts.getMutable(valueCount, bitsRequired,
