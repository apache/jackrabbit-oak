...
public final class BlockPackedReaderIterator {
     ...
     *                  {@link BlockPackedWriter} which has been used to write the stream
     */
    public BlockPackedReaderIterator(DataInput in, int packedIntsVersion, int blockSize,
        long valueCount) {
    ...
    /**
     * Reset the current reader to wrap a stream of <code>valueCount</code> values contained in
     * <code>in</code>. The block size remains unchanged.
     */
    ...
    public void skip(long count) throws IOException {
        ...
        while (count >= blockSize) {
            ...
            final long blockBytes = PackedInts.Format.PACKED.byteCount(packedIntsVersion, blockSize,
                bitsPerValue);
    ...
    private void refill() throws IOException {
        ...
        if (bitsPerValue == 0) {
            ...
            final PackedInts.Decoder decoder = PackedInts.getDecoder(PackedInts.Format.PACKED,
                packedIntsVersion, bitsPerValue);
            ...
            final int blocksCount = (int) PackedInts.Format.PACKED.byteCount(packedIntsVersion,
