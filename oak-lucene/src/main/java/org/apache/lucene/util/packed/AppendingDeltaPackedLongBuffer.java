 ...
 * is optimized for the case where values are close to each other.
 *
 * @lucene.internal
 */
public final class AppendingDeltaPackedLongBuffer extends AbstractAppendingLongBuffer {
     ...
     */
    public AppendingDeltaPackedLongBuffer(int initialPageCount, int pageSize,
    ...
    /**
     * Create an {@link AppendingDeltaPackedLongBuffer} with initialPageCount=16, pageSize=1024 and
