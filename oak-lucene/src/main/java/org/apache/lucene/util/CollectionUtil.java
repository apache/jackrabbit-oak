...
public final class CollectionUtil {
    ...
    /**
     * Sorts the given random access {@link List} in natural order. The list must implement
     * {@link RandomAccess}. This method uses the intro sort algorithm, but falls back to insertion
    ...
    /**
     * Sorts the given random access {@link List} in natural order. The list must implement
     * {@link RandomAccess}. This method uses the Tim sort algorithm, but falls back to binary sort
     * for small lists.
     *
     * @throws IllegalArgumentException if list is e.g. a linked list without random access.
     */
