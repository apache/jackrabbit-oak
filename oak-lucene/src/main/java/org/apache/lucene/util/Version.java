 ...
 * that you supply to components in Lucene, do not simply change the version at search-time, but
...
public enum Version {
     ...
     * upgrade to a newer release of Lucene, sizable changes may happen.  If backwards compatibility
     * is important then you should instead explicitly specify an actual version.
     * <p>
     * If you use this constant then you  may need to
     * <b>re-index all of your documents</b> when upgrading
     * Lucene, as the way text is indexed may have changed. Additionally, you may need to <b>re-test
     * your entire application</b> to ensure it behaves as expected, as some defaults may have
     * changed and may break functionality in your application.
     *
