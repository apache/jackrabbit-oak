...
public class MapOfSets<K, V> {
    ...
    /**
     * Adds val to the Set associated with key in the Map.  If key is not already in the map, a new
     * Set will first be created.
     *
    ...
    /**
     * Adds multiple vals to the Set associated with key in the Map. If key is not already in the
     * map, a new Set will first be created.
     *
     * @return the size of the Set associated with key once val is added to it.
     */
