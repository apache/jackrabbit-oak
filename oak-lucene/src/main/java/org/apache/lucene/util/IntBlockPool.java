...
public final class IntBlockPool {
    ...
    /**
     * array of buffers currently used in the pool. Buffers are allocated if needed don't modify
     ...
     *
     * @param zeroFillBuffers if <code>true</code> the buffers are filled with <tt>0</tt>. This
     *                        should be set to <code>true</code> if this pool is used with
     *                        {@link SliceWriter}.
     ...
     * to initialize the pool. In contrast to the constructor a {@link IntBlockPool#reset()} call
    ...
    /**
     * An array holding the offset into the {@link IntBlockPool#LEVEL_SIZE_ARRAY} to quickly
    ...
    /**
     * A {@link SliceWriter} that allows to write multiple integer slices into a given
     * {@link IntBlockPool}.
     *
     * @lucene.internal
     * @see SliceReader
    ...
    public static class SliceWriter {
        ...
        /**
         * Returns the offset of the currently written slice. The returned value should be used as
         * the end offset to initialize a {@link SliceReader} once this slice is fully written or to
         * reset the this writer if another slice needs to be written.
         */
    ...
    public static final class SliceReader {
         ...
         * <code>true</code> {@link SliceReader#readInt()} should not be called again on this
         * slice.
         */
