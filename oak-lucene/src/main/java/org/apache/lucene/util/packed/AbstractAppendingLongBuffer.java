...
/**
 * Common functionality shared by {@link AppendingDeltaPackedLongBuffer} and
 * {@link MonotonicAppendingLongBuffer}.
 */
abstract class AbstractAppendingLongBuffer extends LongValues {
     ...
     * <code>index</code> into <code>arr[off:off+len]</code> and return the actual number of values
     * that have been read.
     */
