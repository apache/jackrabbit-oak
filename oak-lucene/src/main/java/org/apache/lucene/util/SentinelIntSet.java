...
public class SentinelIntSet {
    ...
    /**
     * @param size     The minimum number of elements this set should be able to hold without
     *                 rehashing (i.e. the slots are guaranteed not to change)
    ...
    /**
     * Puts this integer (key) in the set, and returns the slot index it was added to. It rehashes
     * if adding it would make the set more than 75% full.
     */
