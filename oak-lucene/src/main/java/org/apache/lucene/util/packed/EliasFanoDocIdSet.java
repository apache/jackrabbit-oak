...
public class EliasFanoDocIdSet extends DocIdSet {
    ...
    /**
     * Construct an EliasFanoDocIdSet. For efficient encoding, the parameters should be chosen as
     * low as possible.
     *
    ...
    /**
     * Provide an indication that is better to use an {@link EliasFanoDocIdSet} than a
     * {@link FixedBitSet} to encode document identifiers.
     *
     ...
     *
     * @param disi This DocIdSetIterator should provide document ids that are consistent with
     *             <code>numValues</code> and <code>upperBound</code> as provided to the
     *             constructor.
     */
    ...
    public DocIdSetIterator iterator() {
        if (efEncoder.lastEncoded >= DocIdSetIterator.NO_MORE_DOCS) {
            throw new UnsupportedOperationException(
                "Highest encoded value too high for DocIdSetIterator.NO_MORE_DOCS: "
