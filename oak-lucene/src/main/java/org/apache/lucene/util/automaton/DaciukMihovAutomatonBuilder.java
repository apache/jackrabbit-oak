...
final class DaciukMihovAutomatonBuilder {
    ...
    private final static class State {
        ...
        /**
         * Labels of outgoing transitions. Indexed identically to {@link #states}. Labels must be
         ...
         * <code>label</code>. If no such transition exists, returns
         * <code>null</code>.
         */
    ...
    /**
     * Add another character sequence to this automaton. The sequence must be lexicographically
     * larger or equal compared to any previous sequences added to this automaton (the input must be
     * sorted).
     */
    ...
    /**
     * Replace last child of <code>state</code> with an already registered state or stateRegistry
     * the last child state.
     */
