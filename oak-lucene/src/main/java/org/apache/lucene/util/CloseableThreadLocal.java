 ...
 * <p>
 * While not technically a memory leak, because eventually the memory will be reclaimed, it can take
 * a long time and you can easily hit OutOfMemoryError because from the GC's standpoint the stale
 * entries are not reclaimable.
 * <p>
 ...
 * <p>
 * We can not rely on {@link ThreadLocal#remove()} as it only removes the value for the caller
