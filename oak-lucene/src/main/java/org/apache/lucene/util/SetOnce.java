...
public final class SetOnce<T> implements Cloneable {
    ...
    /**
     * A default constructor which does not set the internal object, and allows setting it by
     * calling {@link #set(Object)}.
     */
    public SetOnce() {
    ...
    /**
     * Creates a new instance with the internal object set to the given object. Note that any calls
     * to {@link #set(Object)} afterwards will result in {@link AlreadySetException}
     *
