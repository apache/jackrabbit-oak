...
public final class FixedBitSet extends DocIdSet implements Bits {
    ...
    /**
     * A {@link DocIdSetIterator} which iterates over set bits in a {@link FixedBitSet}.
     */
    ...
    /**
     * If the given {@link FixedBitSet} is large enough to hold {@code numBits}, returns the given
     * bits, otherwise returns a new {@link FixedBitSet} which can hold the requested number of
     * bits.
     *
     * <p>
    ...
    private void or(final long[] otherArr, final int otherNumWords) {
        assert
            otherNumWords <= numWords : "numWords=" + numWords + ", otherNumWords=" + otherNumWords;
    ...
    public void clear(int startIndex, int endIndex) {
        ...
        assert
            endIndex >= 0 && endIndex <= numBits : "endIndex=" + endIndex + ", numBits=" + numBits;
        if (endIndex <= startIndex) {
            return;
        }
