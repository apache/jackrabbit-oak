...
public interface BytesRefIterator {
    ...
    /**
     * Return the {@link BytesRef} Comparator used to sort terms provided by the iterator. This may
     * return null if there are no items or the iterator is not sorted. Callers may invoke this
     * method many times, so it's best to cache a single instance & reuse it.
     */
