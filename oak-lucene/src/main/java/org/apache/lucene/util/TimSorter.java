 ...
 * configurable. This allows small merges to be very fast while large merges will be performed
 * in-place (slightly slower). You can make sure that the fast merge routine will always be used by
 * having <code>maxTempSlots</code> equal to half of the length of the slice of data to sort.
