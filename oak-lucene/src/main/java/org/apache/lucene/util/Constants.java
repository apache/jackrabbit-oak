...
public final class Constants {
    ...
    /**
     * This is the internal Lucene version, recorded into each segment. NOTE: we track per-segment
     * version as a String with the {@code "X.Y"} format (no minor version), e.g.
     * {@code "4.0", "3.1", "3.0"}.
     * <p>Alpha and Beta versions will have numbers like {@code "X.Y.0.Z"},
     * anything else is not allowed. This is done to prevent people from using indexes created with
     * ALPHA/BETA versions with the released version.
     */
