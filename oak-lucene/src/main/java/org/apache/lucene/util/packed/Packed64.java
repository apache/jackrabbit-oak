 ...
 * </p><p>
 * The implementation strives to perform af fast as possible under the constraint of contiguous
...
class Packed64 extends PackedInts.MutableImpl {
    ...
    public Packed64(int valueCount, int bitsPerValue) {
        ...
        final int longCount = format.longCount(PackedInts.VERSION_CURRENT, valueCount,
            bitsPerValue);
    ...
    public Packed64(int packedIntsVersion, DataInput in, int valueCount, int bitsPerValue)
        ...
        super(valueCount, bitsPerValue);
        final PackedInts.Format format = PackedInts.Format.PACKED;
        final long byteCount = format.byteCount(packedIntsVersion, valueCount,
            bitsPerValue); // to know how much to read
        final int longCount = format.longCount(PackedInts.VERSION_CURRENT, valueCount,
    ...
    public long ramBytesUsed() {
        return RamUsageEstimator.alignObjectSize(
            RamUsageEstimator.NUM_BYTES_OBJECT_HEADER
                ...
                // bpvMinusBlockSize,valueCount,bitsPerValue
