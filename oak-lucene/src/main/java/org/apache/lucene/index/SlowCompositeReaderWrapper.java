 ...
 * emulate an atomic reader.  This requires implementing the postings APIs on-the-fly, using the
 * static methods in {@link MultiFields}, {@link MultiDocValues}, by stepping through the
 * sub-readers to merge fields/terms, appending docs, etc.
 *
 * <p><b>NOTE</b>: this class almost always results in a
 * performance hit.  If this is important to your use case, you'll get better performance by
 * gathering the sub readers using {@link IndexReader#getContext()} to get the atomic leaves and
...
public final class SlowCompositeReaderWrapper extends AtomicReader {
    ...
    /**
     * This method is sugar for getting an {@link AtomicReader} from an {@link IndexReader} of any
