...
public abstract class Fields implements Iterable<String> {
     ...
     *
     * @see Terms#size()
     * @deprecated iterate fields and add their size() instead. this method is only provided as a
     * transition mechanism to access this statistic for 3.x indexes, which do not have this
     * statistic per-field.
     */
    @Deprecated
