...
class AutomatonTermsEnum extends FilteredTermsEnum {
    ...
    /**
     * Construct an enumerator based upon an automaton, enumerating the specified field, working on
     * a supplied TermsEnum
     * <p>
     *
    ...
    /**
     * Returns true if the term matches the automaton. Also stashes away the term to assist with
     * smart enumeration.
     */
    @Override
     ...
     * state.
     * <p>
     * If this cannot satisfy the machine, returns false. This method will walk the minimal path, in
     * lexicographic order, as long as possible.
     * <p>
