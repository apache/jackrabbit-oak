...
public abstract class FilterDirectoryReader extends DirectoryReader {
     ...
     * specialised FilterAtomicReader implementations.
     */
    ...
    /**
     * A no-op SubReaderWrapper that simply returns the parent DirectoryReader's original
     * subreaders.
     */
    ...
    /**
     * Create a new FilterDirectoryReader that filters a passed in DirectoryReader, using the
