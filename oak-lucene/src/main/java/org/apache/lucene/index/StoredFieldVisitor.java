 ...
 * {@link IndexReader#document(int, StoredFieldVisitor)}.
 *
 * <p><b>NOTE</b>: a {@code StoredFieldVisitor} implementation
 * should not try to load or visit other stored documents in the same reader because the
 * implementation of stored fields for most codecs is not reeentrant and you will see strange
 * exceptions as a result.
 *
 * <p>See {@link DocumentStoredFieldVisitor}, which is a
 * <code>StoredFieldVisitor</code> that builds the
 * {@link Document} containing all stored fields.  This is used by
...
public abstract class StoredFieldVisitor {
     ...
     * subclasses can return a {@link Status} representing whether they need that particular field
