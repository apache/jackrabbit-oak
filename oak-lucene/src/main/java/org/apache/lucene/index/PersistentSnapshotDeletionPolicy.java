 ...
 * the same directory across {@link IndexWriter}s will corrupt snapshots. You should make sure every
 * {@link IndexWriter} has its own {@link PersistentSnapshotDeletionPolicy} and that they all write
 * to a different {@link Directory}.  It is OK to use the same Directory that holds the index.
 *
...
public class PersistentSnapshotDeletionPolicy extends SnapshotDeletionPolicy {
     ...
     *                Snapshotted commits, by definition, are not deleted until explicitly released
     *                via {@link #release}.
     ...
     *                snapshots information (immediately), or open an existing index, initializing
     *                the class with the snapshots information.
     */
    public PersistentSnapshotDeletionPolicy(IndexDeletionPolicy primary,
