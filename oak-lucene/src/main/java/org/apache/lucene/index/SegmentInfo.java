...
public final class SegmentInfo {
     ...
     * name is <code>_a</code>; it was created with Lucene 3.1 (or '?' if it's unknown); it's using
     * compound file format (would be <code>C</code> if not compound); it has 45 documents; it has 4
     * deletions (this part is left off when there are no deletions).</p>
     */
     ...
     * This method can be removed when we're not required to support 3x indexes anymore, e.g. in
     * 5.0.
     * <p>
     * <b>NOTE:</b> this method is used for internal purposes only - you should
     * not modify the version of a SegmentInfo, or it may result in unexpected exceptions thrown
     * when you attempt to open the index.
     *
     * @lucene.internal
     */
        ...
        for (String file : files) {
            ...
            if (!m.matches()) {
                throw new IllegalArgumentException(
                    "invalid codec filename '" + file + "', must match: "
