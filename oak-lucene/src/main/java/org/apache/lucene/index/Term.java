...
public final class Term implements Comparable<Term> {
     ...
     * Therefore the bytes should not be modified after construction, for example, you should clone
     * a copy by {@link BytesRef#deepCopyOf} rather than pass reused bytes from a TermsEnum.
     */
    ...
    /**
     * Constructs a Term with the given field and empty text. This serves two purposes: 1) reuse of
     * a Term with the same field. 2) pattern for a query.
     *
    ...
    /**
     * Returns the field of this term.   The field indicates the part of a document which this term
     * came from.
     */
    ...
    /**
     * Returns human-readable form of the term text. If the term is not unicode, the raw bytes will
     * be printed instead.
     */
    public static final String toString(BytesRef termText) {
        ...
        try {
            return decoder.decode(ByteBuffer.wrap(termText.bytes, termText.offset, termText.length))
                          .toString();
     ...
     * zero if this term is equal to the argument, and a positive integer if this term belongs after
     * the argument.
     * <p>
     ...
     * <p>WARNING: the provided BytesRef is not copied, but used directly.
     * Therefore the bytes should not be modified after construction, for example, you should clone
     * a copy rather than pass reused bytes from a TermsEnum.
     */
