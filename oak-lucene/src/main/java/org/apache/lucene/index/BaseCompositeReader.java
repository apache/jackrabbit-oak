 ...
 * composite reader on a set of sub-readers (like several {@link DirectoryReader}s).
 *
...
public abstract class BaseCompositeReader<R extends IndexReader> extends CompositeReader {
     ...
     *                   {@link #getSequentialSubReaders} and used to resolve the correct subreader
     *                   for docID-based methods. <b>Please note:</b> This array is <b>not</b>
     *                   cloned and not protected for modification, the subclass is responsible to
     *                   do this.
     */
