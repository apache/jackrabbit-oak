...
/**
 * {@code AtomicReader} is an abstract class, providing an interface for accessing an index.  Search
 * of an index is done entirely through this abstract interface, so that any subclass which
 * implements it is searchable. IndexReaders implemented by this subclass do not consist of several
...
public abstract class AtomicReader extends IndexReader {
     ...
     *
     * @deprecated (4.0) use {@link #getFieldInfos()} and check {@link FieldInfo#hasNorms()} for the
     * field instead.
     */
    @Deprecated
    ...
    /**
     * Returns {@link Fields} for this reader. This method may return null if the reader has no
     * postings.
     */
    ...
    /**
     * Returns {@link DocsEnum} for the specified term. This will return null if either the field or
     * term does not exist.
     *
    ...
    /**
     * Returns {@link DocsAndPositionsEnum} for the specified term.  This will return null if the
    ...
    /**
     * Returns {@link NumericDocValues} for this field, or null if no {@link NumericDocValues} were
     * indexed for this field.  The returned instance should only be used by a single thread.
     */
    public abstract NumericDocValues getNumericDocValues(String field) throws IOException;

    /**
     * Returns {@link BinaryDocValues} for this field, or null if no {@link BinaryDocValues} were
     * indexed for this field.  The returned instance should only be used by a single thread.
     */
    ...
    /**
     * Returns a {@link Bits} at the size of <code>reader.maxDoc()</code>, with turned on bits for
     * each docid that does have a value for this field, or null if no DocValues were indexed for
    ...
    /**
     * Returns {@link NumericDocValues} representing norms for this field, or null if no
     * {@link NumericDocValues} were indexed. The returned instance should only be used by a single
     * thread.
     */
    ...
    /**
     * Returns the {@link Bits} representing live (not deleted) docs.  A set bit indicates the doc
     * ID has not been deleted.  If this method returns null it means there are no deleted documents
