...
public class MergeState {
    ...
    /**
     * Holds the CheckAbort instance, which is invoked periodically to see if the merge has been
     * aborted.
     */
     ...
     * Sole constructor.
     */
    MergeState(List<AtomicReader> readers, SegmentInfo segmentInfo, InfoStream infoStream,
    ...
    public static class CheckAbort {
        ...
        /**
         * Records the fact that roughly units amount of work have been done since this method was
         * last called. When adding time-consuming code into SegmentMerger, you should test
         * different values for units to ensure that the time in between calls to merge.checkAborted
         * is up to ~ 1 second.
         */
