...
final class MultiBits implements Bits {
    ...
    private boolean checkLength(int reader, int doc) {
        ...
        assert
            ...
            "doc=" + doc + " reader=" + reader + " starts[reader]=" + starts[reader] + " length="
                + length;
        return true;
    }
     ...
     * <p>
     * Because <code>null</code> usually has a special meaning for Bits (e.g. no deleted documents),
     * you must check {@link SubResult#matches} instead to ensure the sub was actually found.
     */
