...
/**
 * This is a DocConsumer that gathers all fields under the same name, and calls per-field consumers
 * to process field by field.  This class doesn't doesn't do any "real" work of its own: it just
 * forwards the fields to a DocFieldConsumer.
 */
...
final class DocFieldProcessor extends DocConsumer {
    ...
    public DocFieldProcessor(DocumentsWriterPerThread docWriter, DocFieldConsumer consumer,
        StoredFieldsConsumer storedConsumer) {
    ...
    public void flush(SegmentWriteState state) throws IOException {
        ...
        infosWriter.write(state.directory, state.segmentInfo.name, "", state.fieldInfos,
            IOContext.DEFAULT);
    }
    ...
    public void processDocument(FieldInfos.Builder fieldInfos) throws IOException {
        ...
        for (IndexableField field : docState.doc) {
            ...
            if (fp == null) {
                ...
                FieldInfo fi = fieldInfos.addOrUpdate(fieldName, field.fieldType());
                assert
                    fi == fp.fieldInfo : "should only have updated an existing FieldInfo instance";
            }
        ...
        if (docState.maxTermPrefix != null && docState.infoStream.isEnabled("IW")) {
            docState.infoStream.message("IW",
                "WARNING: document contains at least one immense term (whose UTF8 encoding is longer than the max length "
