...
public class IOContext {
    ...
    /**
     * Context is a enumerator which specifies the context in which the Directory is being used
     * for.
     */
    public enum Context {
    ...
    private IOContext(Context context, MergeInfo mergeInfo) {
        assert context != Context.MERGE
            || mergeInfo != null : "MergeInfo must not be null if context is MERGE";
