...
/**
 * Simple standalone tool that forever acquires & releases a lock using a specific LockFactory.  Run
 * without any args to see usage.
 *
...
public class LockStressTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            lockFactory = Class.forName(lockFactoryClassName).asSubclass(LockFactory.class)
                               .newInstance();
        ...
        LockFactory verifyLF = new VerifyingLockFactory((byte) myID, lockFactory, verifierHost,
            verifierPort);
