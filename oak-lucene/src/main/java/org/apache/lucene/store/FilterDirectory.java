 ...
 * limitations on top of an existing {@link Directory} implementation such as
 * {@link RateLimitedDirectoryWrapper rate limiting} or to add additional sanity checks for tests.
 * However, if you plan to write your own {@link Directory} implementation, you should consider
 * extending directly {@link Directory} or {@link BaseDirectory} rather than try to reuse
