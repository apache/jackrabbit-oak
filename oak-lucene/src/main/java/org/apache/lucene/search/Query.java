...
public abstract class Query implements Cloneable {
    ...
    /**
     * Sets the boost for this query clause to <code>b</code>.  Documents matching this clause will
     * (in addition to the normal weightings) have their score multiplied by <code>b</code>.
     */
    ...
    /**
     * Gets the boost for this clause.  Documents matching this clause will (in addition to the
     * normal weightings) have their score multiplied by <code>b</code>.   The boost is 1.0 by
     * default.
     */
    ...
    public Weight createWeight(IndexSearcher searcher) throws IOException {
        throw new UnsupportedOperationException(
            "Query " + this + " does not implement createWeight");
    }
    ...
    /**
     * Expert: adds all terms occurring in this query to the terms set. Only works if this query is
     * in its {@link #rewrite rewritten} form.
     *
