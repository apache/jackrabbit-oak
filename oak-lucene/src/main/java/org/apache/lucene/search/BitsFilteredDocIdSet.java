 ...
 * Bits instance. This is especially useful in {@link org.apache.lucene.search.Filter} to apply the
...
public final class BitsFilteredDocIdSet extends FilteredDocIdSet {
     ...
     *                   DocIdSet. If {@code null}, this method returns the original set without
     *                   wrapping.
     */
    public static DocIdSet wrap(DocIdSet set, Bits acceptDocs) {
        return (set == null || acceptDocs == null) ? set
            : new BitsFilteredDocIdSet(set, acceptDocs);
    }
