...
public abstract class Filter {
     ...
     * <p>
     * Note: This method will be called once per segment in the index during searching.  The
     ...
     *                   represent the whole underlying index i.e. if the index has more than one
     *                   segment the given reader only represents a single segment. The provided
     *                   context is always an atomic context, so you can call
     *                   {@link AtomicReader#fields()} on the context's reader, for example.
