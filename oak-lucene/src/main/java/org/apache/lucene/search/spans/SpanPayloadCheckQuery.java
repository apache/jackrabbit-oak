 ...
 * {@link org.apache.lucene.search.spans.SpanNearQuery}.  Instead, use
 * {@link SpanNearPayloadCheckQuery} since it properly handles the fact that payloads aren't ordered
 * by {@link org.apache.lucene.search.spans.SpanNearQuery}.
 **/
public class SpanPayloadCheckQuery extends SpanPositionCheckQuery {
    ...
    /**
     * @param match          The underlying {@link org.apache.lucene.search.spans.SpanQuery} to
     *                       check
    ...
    public SpanPayloadCheckQuery clone() {
        SpanPayloadCheckQuery result = new SpanPayloadCheckQuery((SpanQuery) match.clone(),
            payloadToMatch);
