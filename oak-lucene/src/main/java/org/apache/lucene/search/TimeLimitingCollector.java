...
public class TimeLimitingCollector extends Collector {
    ...
    /**
     * Syntactic sugar for {@link #setBaseline(long)} using {@link Counter#get()} on the clock
     ...
     * collector to collect current doc and only then throw a {@link TimeExceededException}.
     *
    ...
    /**
     * Calls {@link Collector#collect(int)} on the decorated {@link Collector} unless the allowed
     * time has passed, in which case it throws an exception.
     *
     * @throws TimeExceededException if the time allowed has exceeded.
     */
    @Override
     ...
     * <p>
     * Invoking this creates may create a new instance of {@link TimerThread} iff the global
     * {@link TimerThread} has never been accessed before. The thread returned from this method is
     * started on creation and will be alive unless you stop the {@link TimerThread} via
     * {@link TimerThread#stopTimer()}.
     * </p>
     *
    ...
    public static final class TimerThread extends Thread {
        ...
        /**
         * Set the timer resolution. The default timer resolution is 20 milliseconds. This means
         * that a search required to take no longer than 800 milliseconds may be stopped after 780
         * to 820 milliseconds.
         * <br>Note that:
         * <ul>
        ...
        public void setResolution(long resolution) {
            this.resolution = Math.max(resolution,
                5); // 5 milliseconds is about the minimum reasonable time for a Object.wait(long) call.
        }
    }
