 ...
 * the same time by two threads, because in this case you cannot in general know which thread
 * "won".
 */
...
public abstract class LiveFieldValues<S, T> implements ReferenceManager.RefreshListener, Closeable {
    ...
    /**
     * This is called when the id/value was already flushed & opened in an NRT IndexSearcher.  You
