...
public class BasicStats extends Similarity.SimWeight {
    ...
    /**
     * For most Similarities, the immediate and the top level query boosts are not handled
     * differently. Hence, this field is just the product of the other two.
     */
    ...
    /**
     * Computes the raw normalization value. This basic implementation returns the query boost.
     * Subclasses may override this method to include other factors (such as idf), or to save the
     * value for inclusion in {@link #normalize(float, float)}, etc.
     */
    ...
    /**
     * No normalization is done. {@code topLevelBoost} is saved in the object, however.
     */
    @Override
