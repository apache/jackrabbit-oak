...
public interface FieldCache {
     ...
     * {@link SortField#SortField(String, FieldCache.Parser)}.
     */
    public interface Parser {

        /**
         * Pulls a {@link TermsEnum} from the given {@link Terms}. This method allows certain
         * parsers to filter the actual TermsEnum before the field cache is filled.
         *
         * @param terms the {@link Terms} instance to create the {@link TermsEnum} from.
         * @return a possibly filtered {@link TermsEnum} instance, this method must not return
         * <code>null</code>.
    ...
    /**
     * A parser instance for int values encoded by {@link NumericUtils}, e.g. when indexed via
     * {@link IntField}/{@link NumericTokenStream}.
     */
    ...
    /**
     * A parser instance for float values encoded with {@link NumericUtils}, e.g. when indexed via
     * {@link FloatField}/{@link NumericTokenStream}.
     */
    ...
    /**
     * A parser instance for long values encoded by {@link NumericUtils}, e.g. when indexed via
     * {@link LongField}/{@link NumericTokenStream}.
     */
    ...
    /**
     * A parser instance for double values encoded with {@link NumericUtils}, e.g. when indexed via
     * {@link DoubleField}/{@link NumericTokenStream}.
     */
     ...
     * <code>field</code> and returns a bit set at the size of
    ...
    /**
     * Checks the internal cache for an appropriate entry, and if none is found, reads the terms in
     * <code>field</code> as a single byte and returns an array of size
     ...
     * @param setDocsWithField If true then {@link #getDocsWithField} will also be computed and
     *                         stored in the FieldCache.
     * @return The values in the given field for each document.
     * @throws IOException If any error occurs.
     * @deprecated (4.4) Index as a numeric field using {@link IntField} and then use
     * {@link #getInts(AtomicReader, String, boolean)} instead.
     */
    @Deprecated
    ...
    /**
     * Checks the internal cache for an appropriate entry, and if none is found, reads the terms in
     * <code>field</code> as bytes and returns an array of size <code>reader.maxDoc()</code> of the
     * value each document has in the given field.
     *
     * @param reader           Used to get field values.
    ...
    /**
     * Checks the internal cache for an appropriate entry, and if none is found, reads the terms in
     * <code>field</code> as shorts and returns an array of size <code>reader.maxDoc()</code> of
     * the
     * value each document has in the given field.
     *
     * @param reader           Used to get field values.
    ...
    /**
     * Returns an {@link Ints} over the values found in documents in the given field. If the field
     * was indexed as {@link NumericDocValuesField}, it simply uses
     * {@link AtomicReader#getNumericDocValues(String)} to read the values. Otherwise, it checks the
     * internal cache for an appropriate entry, and if none is found, reads the terms in
     * <code>field</code> as ints and returns an array of size <code>reader.maxDoc()</code> of the
     * value each document has in the given field.
     *
     * @param reader           Used to get field values.
     * @param field            Which field contains the longs.
     * @param parser           Computes int for string values. May be {@code null} if the requested
     *                         field was indexed as {@link NumericDocValuesField} or
     *                         {@link IntField}.
     * @param setDocsWithField If true then {@link #getDocsWithField} will also be computed and
     *                         stored in the FieldCache.
     * @return The values in the given field for each document.
    ...
    /**
     * Returns a {@link Floats} over the values found in documents in the given field.
     *
    ...
    /**
     * Returns a {@link Floats} over the values found in documents in the given field. If the field
     * was indexed as {@link NumericDocValuesField}, it simply uses
     * {@link AtomicReader#getNumericDocValues(String)} to read the values. Otherwise, it checks the
     * internal cache for an appropriate entry, and if none is found, reads the terms in
     * <code>field</code> as floats and returns an array of size <code>reader.maxDoc()</code> of
     * the
     * value each document has in the given field.
     *
     * @param reader           Used to get field values.
     * @param field            Which field contains the floats.
     * @param parser           Computes float for string values. May be {@code null} if the
    ...
    /**
     * Returns a {@link Longs} over the values found in documents in the given field.
     *
    ...
    /**
     * Returns a {@link Longs} over the values found in documents in the given field. If the field
     * was indexed as {@link NumericDocValuesField}, it simply uses
     * {@link AtomicReader#getNumericDocValues(String)} to read the values. Otherwise, it checks the
     * internal cache for an appropriate entry, and if none is found, reads the terms in
     * <code>field</code> as longs and returns an array of size <code>reader.maxDoc()</code> of the
     * value each document has in the given field.
     *
     * @param reader           Used to get field values.
     * @param field            Which field contains the longs.
     * @param parser           Computes long for string values. May be {@code null} if the requested
     *                         field was indexed as {@link NumericDocValuesField} or
     *                         {@link LongField}.
     * @param setDocsWithField If true then {@link #getDocsWithField} will also be computed and
     *                         stored in the FieldCache.
     ...
     * @throws IOException If any error occurs.
     */
    public Longs getLongs(AtomicReader reader, String field, LongParser parser,
        boolean setDocsWithField) throws IOException;

    /**
     * Returns a {@link Doubles} over the values found in documents in the given field.
     *
    ...
    /**
     * Returns a {@link Doubles} over the values found in documents in the given field. If the field
     * was indexed as {@link NumericDocValuesField}, it simply uses
     * {@link AtomicReader#getNumericDocValues(String)} to read the values. Otherwise, it checks the
     * internal cache for an appropriate entry, and if none is found, reads the terms in
     * <code>field</code> as doubles and returns an array of size <code>reader.maxDoc()</code> of
     * the value each document has in the given field.
     *
     * @param reader           Used to get field values.
     * @param field            Which field contains the longs.
     * @param parser           Computes double for string values. May be {@code null} if the
     *                         requested field was indexed as {@link NumericDocValuesField} or
     *                         {@link DoubleField}.
     * @param setDocsWithField If true then {@link #getDocsWithField} will also be computed and
     *                         stored in the FieldCache.
     ...
     * @throws IOException If any error occurs.
     */
    public Doubles getDoubles(AtomicReader reader, String field, DoubleParser parser,
        boolean setDocsWithField) throws IOException;

    /**
     * Checks the internal cache for an appropriate entry, and if none is found, reads the term
     * values in <code>field</code> and returns a {@link BinaryDocValues} instance, providing a
    ...
    /**
     * Expert: just like {@link #getTerms(AtomicReader, String, boolean)}, but you can specify
     * whether more RAM should be consumed in exchange for faster lookups (default is "true").  Note
     * that the first call for a given reader and field "wins", subsequent calls will share the same
     * cache entry.
     */
    public BinaryDocValues getTerms(AtomicReader reader, String field, boolean setDocsWithField,
    ...
    /**
     * Checks the internal cache for an appropriate entry, and if none is found, reads the term
     * values in <code>field</code> and returns a {@link SortedDocValues} instance, providing
     * methods to retrieve sort ordinals and terms (as a ByteRef) per document.
     *
     * @param reader Used to get field values.
     * @param field  Which field contains the strings.
     * @return The values in the given field for each document.
    ...
    /**
     * Expert: just like {@link #getTermsIndex(AtomicReader, String)}, but you can specify whether
     * more RAM should be consumed in exchange for faster lookups (default is "true").  Note that
     * the first call for a given reader and field "wins", subsequent calls will share the same
     * cache entry.
     */
    ...
    /**
     * Checks the internal cache for an appropriate entry, and if none is found, reads the term
     * values in <code>field</code> and returns a {@link DocTermOrds} instance, providing a method
     * to retrieve the terms (as ords) per document.
     *
     ...
     * FieldCache.
     * <p>
     * NOTE: These CacheEntry objects maintain a strong reference to the Cached Values.  Maintaining
     * references to a CacheEntry the AtomicIndexReader associated with it has garbage collected
     * will prevent the Value itself from being garbage collected when the Cache drops the
     * WeakReference.
     * </p>
     *
     * @lucene.experimental
     ...
     * This is intended only to be used for test methods as a way to ensure a known base state of
     * the Cache (with out needing to rely on GC to free WeakReferences). It should not be relied on
     * for "Cache maintenance" in general application code.
     * </p>
     *
     * @lucene.experimental
     */
     ...
     * {@link IndexReader#getCoreCacheKey}.  NOTE: this cache key must precisely match the reader
     * that the cache entry is keyed on. If you pass a top-level reader, it usually will have no
     * effect as Lucene now caches at the segment reader level.
     */
    public void purgeByCacheKey(Object coreCacheKey);

    /**
     * If non-null, FieldCacheImpl will warn whenever entries are created that are not sane
     * according to {@link org.apache.lucene.util.FieldCacheSanityChecker}.
     */
