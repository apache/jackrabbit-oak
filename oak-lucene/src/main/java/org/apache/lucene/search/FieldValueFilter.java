...
/**
 * A {@link Filter} that accepts all documents that have one or more values in a given field. This
 * {@link Filter} request {@link Bits} from the {@link FieldCache} and build the bits if not
 * present.
 */
public class FieldValueFilter extends Filter {
     ...
     *
     * @param field  the field to filter
     * @param negate iff <code>true</code> all documents with no value in the given field are
     *               accepted.
     */
