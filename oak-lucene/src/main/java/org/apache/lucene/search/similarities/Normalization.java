...
public abstract class Normalization {
     ...
     * and the average field length to compute the normalized term frequency. This method provides a
     * generic explanation for such methods. Subclasses that use other statistics must override this
     * method.</p>
     */
    ...
    /**
     * Subclasses must override this method to return the code of the normalization formula. Refer
     * to the original paper for the list.
     */
    @Override
