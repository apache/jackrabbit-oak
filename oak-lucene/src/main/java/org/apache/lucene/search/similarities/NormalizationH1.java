 ...
 * original article</a>, <a href="http://dl.acm.org/citation.cfm?id=1835490"> information-based
 * models</a> (see {@link IBSimilarity}) introduced a multiplying factor. The default value for the
 * {@code c} parameter is {@code 1}.</p>
 *
 * @lucene.experimental
 */
