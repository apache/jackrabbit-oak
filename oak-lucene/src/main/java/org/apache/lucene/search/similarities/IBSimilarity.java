 ...
 * -x<sup>q</sup><sub>w</sub> log Prob(X<sub>w</sub> &ge; t<sup>d</sup><sub>w</sub> |
 * &lambda;<sub>w</sub>)</em>, where
 * <ul>
...
public class IBSimilarity extends SimilarityBase {
     ...
     * <p>
     * Note that <code>null</code> values are not allowed: if you want no normalization, instead
