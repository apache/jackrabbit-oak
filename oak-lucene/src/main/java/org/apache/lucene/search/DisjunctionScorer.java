...
/**
 * Base class for Scorers that score disjunctions. Currently this just provides helper methods to
 * manage the heap.
 */
abstract class DisjunctionScorer extends Scorer {
     ...
     * <p>
     * {@code subScorers[0]} will be positioned to the new docid, which could be
     * {@code NO_MORE_DOCS} (subclass must handle this).
     * <p>
     * implementations should assign {@code doc} appropriately, and do any other work necessary to
     * implement {@code score()} and {@code freq()}
     */
