 ...
 * <p/>
 * This class is a simple extension of {@link SpanPositionRangeQuery} in that it assumes the start
 * to be zero and only checks the end boundary.
 */
public class SpanFirstQuery extends SpanPositionRangeQuery {

    /**
     * Construct a SpanFirstQuery matching spans in <code>match</code> whose end position is less
