 ...
 * {@link #add(Term[])}. To use this class, to search for the phrase "Microsoft app*" first use
 * add(Term) on the term "Microsoft", then find all terms that have "app" as prefix using
 * IndexReader.terms(Term), and use MultiPhraseQuery.add(Term[] terms) to add them to the query.
 */
    ...
    private class MultiPhraseWeight extends Weight {
        ...
        public Scorer scorer(AtomicReaderContext context, boolean scoreDocsInOrder,
            ...
            for (int pos = 0; pos < postingsFreqs.length; pos++) {
                ...
                if (terms.length > 1) {
                    postingsEnum = new UnionDocsAndPositionsEnum(liveDocs, context, terms,
                        termContexts, termsEnum);
                    ...
                    if (postingsEnum == null) {
                        ...
                        assert termsEnum.docs(liveDocs, null, DocsEnum.FLAG_NONE)
                            != null : "termstate found but no term exists in reader";
                ...
                postingsFreqs[pos] = new PhraseQuery.PostingsAndFreq(postingsEnum, docFreq,
