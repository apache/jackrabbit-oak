...
/**
 * A {@link Filter} that only accepts numeric values within a specified range. To use this, you must
 * first index the numeric values using {@link IntField}, {@link FloatField}, {@link LongField} or
 * {@link DoubleField} (expert: {@link NumericTokenStream}).
 *
 ...
 * </pre>
 * <p>
 * accepts all documents whose float valued "weight" field ranges from 0.03 to 0.10, inclusive. See
 * {@link NumericRangeQuery} for details on how Lucene indexes and searches numeric valued fields.
 *
 * @since 2.9
 **/
public final class NumericRangeFilter<T extends Number> extends
     ...
     * href="NumericRangeQuery.html#precisionStepDesc"><code>precisionStep</code></a>. You can have
    ...
    public static NumericRangeFilter<Long> newLongRange(final String field, final int precisionStep,
        ...
        return new NumericRangeFilter<Long>(
            NumericRangeQuery.newLongRange(field, precisionStep, min, max, minInclusive,
                maxInclusive)
        );
    }
     ...
     * fact &lt;/&le; or &gt;/&ge; queries) by setting the min or max value to <code>null</code>. By
    ...
    /**
     * Factory that creates a <code>NumericRangeFilter</code>, that filters a <code>int</code> range
     * using the given <a
     * href="NumericRangeQuery.html#precisionStepDesc"><code>precisionStep</code></a>. You can have
     * half-open ranges (which are in fact &lt;/&le; or &gt;/&ge; queries) by setting the min or max
     * value to <code>null</code>. By setting inclusive to false, it will match all documents
    ...
    public static NumericRangeFilter<Integer> newIntRange(final String field,
        ...
        return new NumericRangeFilter<Integer>(
            NumericRangeQuery.newIntRange(field, precisionStep, min, max, minInclusive,
                maxInclusive)
        );
    }
    ...
    public static NumericRangeFilter<Double> newDoubleRange(final String field,
        ...
        return new NumericRangeFilter<Double>(
            NumericRangeQuery.newDoubleRange(field, precisionStep, min, max, minInclusive,
                maxInclusive)
        );
    }
     ...
     * href="NumericRangeQuery.html#precisionStepDesc"><code>precisionStep</code></a>. You can have
     * half-open ranges (which are in fact &lt;/&le; or &gt;/&ge; queries) by setting the min or max
     * value to <code>null</code>. {@link Float#NaN} will never match a half-open range, to hit
     * {@code NaN} use a query with {@code min == max == Float.NaN}. By setting inclusive to false,
     * it will match all documents excluding the bounds, with inclusive on, the boundaries are hits,
     * too.
     */
    public static NumericRangeFilter<Float> newFloatRange(final String field,
        ...
        return new NumericRangeFilter<Float>(
            NumericRangeQuery.newFloatRange(field, precisionStep, min, max, minInclusive,
                maxInclusive)
        );
    }
