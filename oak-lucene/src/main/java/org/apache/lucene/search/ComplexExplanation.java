...
/**
 * Expert: Describes the score computation for document and query, and can distinguish a match
 * independent of a positive value.
 */
public class ComplexExplanation extends Explanation {
     ...
     *
     * <p>
     * If the match status is explicitly set (i.e.: not null) this method uses it; otherwise it
     * defers to the superclass.
     * </p>
     *
     * @see #getMatch
     */
