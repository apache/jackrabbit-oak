...
/**
 * This class is very similar to {@link org.apache.lucene.search.spans.SpanTermQuery} except that it
 * factors in the value of the payload located at each of the positions where the
...
public class PayloadTermQuery extends SpanTermQuery {
    ...
    protected class PayloadTermWeight extends SpanWeight {
                ...
                if (termSpans.isPayloadAvailable()) {
                    ...
                    if (payload != null) {
                        payloadScore = function.currentScore(doc, term.field(),
                            ...
                            docScorer.computePayloadFactor(doc, spans.start(), spans.end(),
                                payload));
                    } else {
                        payloadScore = function.currentScore(doc, term.field(),
        ...
        public Explanation explain(AtomicReaderContext context, int doc) throws IOException {
            PayloadTermSpanScorer scorer = (PayloadTermSpanScorer) scorer(context, true, false,
