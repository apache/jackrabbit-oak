...
public class BooleanClause {
    ...
    public static enum Occur {
         ...
         * BooleanQuery with no <code>MUST</code> clauses one or more <code>SHOULD</code> clauses
         ...
         * that it is not possible to search for queries that only consist of a
         * <code>MUST_NOT</code> clause.
         */
        MUST_NOT {
            @Override
            public String toString() {
