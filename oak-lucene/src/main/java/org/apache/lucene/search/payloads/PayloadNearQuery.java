...
/**
 * This class is very similar to {@link org.apache.lucene.search.spans.SpanNearQuery} except that it
 * factors in the value of the payloads located at each of the positions where the
 * {@link org.apache.lucene.search.spans.TermSpans} occurs.
 * <p/>
 * NOTE: In order to take advantage of this with the default scoring implementation
 * ({@link DefaultSimilarity}), you must override
 * {@link DefaultSimilarity#scorePayload(int, int, int, BytesRef)}, which returns 1 by default.
 * <p/>
 * Payload scores are aggregated using a pluggable {@link PayloadFunction}.
 *
 * @see org.apache.lucene.search.similarities.Similarity.SimScorer#computePayloadFactor(int, int,
 * int, BytesRef)
 */
public class PayloadNearQuery extends SpanNearQuery {
    ...
    public class PayloadNearSpanWeight extends SpanWeight {
        ...
        public Scorer scorer(AtomicReaderContext context, boolean scoreDocsInOrder,
            ...
            return new PayloadNearSpanScorer(query.getSpans(context, acceptDocs, termContexts),
                this,
        ...
        public Explanation explain(AtomicReaderContext context, int doc) throws IOException {
            PayloadNearSpanScorer scorer = (PayloadNearSpanScorer) scorer(context, true, false,
            ...
            if (scorer != null) {
                ...
                if (newDoc == doc) {
                    ...
                    Explanation payloadExpl = function.explain(doc, field, scorer.payloadsSeen,
                        scorer.payloadScore);
                    // combined
    ...
    public class PayloadNearSpanScorer extends SpanScorer {
        ...
        /**
         * By default, uses the {@link PayloadFunction} to score the payloads, but can be overridden
         * to do other things.
         *
