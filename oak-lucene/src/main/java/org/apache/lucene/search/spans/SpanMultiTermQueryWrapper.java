...
public class SpanMultiTermQueryWrapper<Q extends MultiTermQuery> extends SpanQuery {
     ...
     *              Doing so will throw {@link UnsupportedOperationException} on rewriting this
     *              query!
     */
     ...
     * {@link Occur#SHOULD} clause in a BooleanQuery, and keeps the scores as computed by the
     * query.
     *
