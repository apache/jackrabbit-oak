...
/**
 * Subclass of FilteredTermEnum for enumerating all terms that match the specified range
 * parameters.
...
public class TermRangeTermsEnum extends FilteredTermsEnum {
    ...
    /**
     * Enumerates all terms greater/equal than <code>lowerTerm</code> but less/equal than
     * <code>upperTerm</code>.
     * <p>
     ...
     *
     * @param tenum        TermsEnum to filter
