...
public class SortField {
    ...
    public static enum Type {
        ...
        /**
         * Sort using term values as encoded Longs.  Sort values are Long and lower values are at
         * the front.
         */
        LONG,

        /**
         * Sort using term values as encoded Doubles.  Sort values are Double and lower values are
         * at the front.
         */
        DOUBLE,

        /**
         * Sort using term values as encoded Shorts.  Sort values are Short and lower values are at
         * the front.
         */
        @Deprecated
        SHORT,
        ...
        /**
         * Sort using a custom Comparator.  Sort values are any Comparable and sorting is done
         * according to natural order.
         */
        CUSTOM,

        /**
         * Sort using term values as encoded Bytes.  Sort values are Byte and lower values are at
         * the front.
         */
        @Deprecated
        BYTE,
        ...
        /**
         * Sort using term values as Strings, but comparing by value (using String.compareTo) for
         * all comparisons. This is typically slower than {@link #STRING}, which uses ordinals to do
         * the sorting.
         */
        STRING_VAL,
        ...
        /**
         * Force rewriting of SortField using {@link SortField#rewrite(IndexSearcher)} before it can
         * be used for sorting
         */
        REWRITEABLE
    }
     ...
     * {@link FieldCache.Parser}.
     *
     * @param field  Name of field to sort by.  Must not be null.
     * @param parser Instance of a {@link FieldCache.Parser}, which must subclass one of the
     *               existing numeric parsers from {@link FieldCache}. Sort type is inferred by
     *               testing which numeric parser the parser subclasses.
     * @throws IllegalArgumentException if the parser fails to subclass an existing numeric parser,
     *                                  or field is null
     */
    ...
    /**
     * Creates a sort, possibly in reverse, by terms in the given field, parsed to numeric values
     * using a custom {@link FieldCache.Parser}.
     *
     * @param field   Name of field to sort by.  Must not be null.
     * @param parser  Instance of a {@link FieldCache.Parser}, which must subclass one of the
     *                existing numeric parsers from {@link FieldCache}. Sort type is inferred by
    ...
    public void setMissingValue(Object missingValue) {
        ...
        } else if (type != Type.BYTE && type != Type.SHORT && type != Type.INT && type != Type.FLOAT
    ...
    /**
     * Returns the name of the field.  Could return <code>null</code> if the sort is by SCORE or
     * DOC.
     *
    ...
    /**
     * Returns the instance of a {@link FieldCache} parser that fits to the given sort type. May
     * return <code>null</code> if no parser was specified. Sorting is using the default parser
     * then.
     *
    ...
    public String toString() {
        ...
        switch (type) {
            ...
            case CUSTOM:
                buffer.append("<custom:\"").append(field).append("\": ").append(comparatorSource)
                      .append('>');
                break;
    ...
    /**
     * Returns true if <code>o</code> is equal to this.  If a {@link FieldComparatorSource} or
     * {@link FieldCache.Parser} was provided, it must properly implement equals (unless a singleton
     * is always used).
     */
    @Override
    ...
    /**
     * Returns true if <code>o</code> is equal to this.  If a {@link FieldComparatorSource} or
     * {@link FieldCache.Parser} was provided, it must properly implement hashCode (unless a
     ...
     * override this define their rewriting behavior when this SortField is of type
     * {@link SortField.Type#REWRITEABLE}
     *
