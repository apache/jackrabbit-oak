...
/**
 * Base class for DocIdSet to be used with FieldCache. The implementation of its iterator is very
 * stupid and slow if the implementation of the {@link #matchDoc} method is not optimized, as
 * iterators simply increment the document id until {@code matchDoc(int)} returns true. Because of
 * this {@code matchDoc(int)} must be as fast as possible and in no case do any I/O.
 *
 * @lucene.internal
 */
