 ...
 *
 * @lucene.experimental <p> WARNING: for terms that do not meet the expected random distribution
 * (e.g. stopwords), this model may give poor performance, such as abnormally high scores for low tf
 * values.
 */
