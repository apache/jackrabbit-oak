...
public abstract class TopTermsRewrite<Q extends Query> extends TermCollectingRewrite<Q> {
    ...
    public final Q rewrite(final IndexReader reader, final MultiTermQuery query)
        ...
        collectTerms(reader, query, new TermCollector() {
            ...
            private boolean compareToLastTerm(BytesRef t) {
                if (lastTerm == null && t != null) {
                    ...
                    assert
                        termsEnum.getComparator().compare(lastTerm, t) < 0 :
                        "lastTerm=" + lastTerm + " t=" + t;
        ...
        for (final ScoreTerm st : scoreTerms) {
            ...
            assert
                reader.docFreq(term) == st.termState.docFreq() :
                "reader DF is " + reader.docFreq(term) + " vs " + st.termState.docFreq() + " term="
                    + term;
