 ...
 * DFR framework. Basic models compute the
...
public abstract class BasicModel {
     ...
     * frequency to compute Inf<sub>1</sub>. This method provides a generic explanation for such
     * models. Subclasses that use other statistics must override this method.</p>
     */
