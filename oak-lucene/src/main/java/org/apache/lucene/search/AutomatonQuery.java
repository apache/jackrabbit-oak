 ...
 * <p>
 * This query will match documents that contain terms accepted by a given finite-state machine. The
 * automaton can be constructed with the {@link org.apache.lucene.util.automaton} API.
 ...
 * </p>
 * <p>
 * When the query is executed, it will create an equivalent DFA of the finite-state machine, and
