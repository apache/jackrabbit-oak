...
final class HitQueue extends PriorityQueue<ScoreDoc> {
     ...
     * with sentinel objects and set its {@link #size()} to <code>size</code>. In that case, you
     * should not rely on {@link #size()} to get the number of actual elements that were added to
     * the queue, but keep track yourself.<br>
