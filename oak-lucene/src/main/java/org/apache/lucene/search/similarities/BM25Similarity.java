...
public class BM25Similarity extends Similarity {
     ...
     * returns <code>1</code> if the index does not store sumTotalTermFreq (Lucene 3.x indexes or
     ...
     * {@link SmallFloat#floatToByte315(float)}.  This is compatible with Lucene's default
     * implementation.  If you change this, then you should change {@link #decodeNormValue(byte)} to
     * match.
     */
    ...
    private Explanation explainScore(int doc, Explanation freq, BM25Stats stats,
        ...
        if (norms == null) {
            ...
            tfNormExpl.setValue((freq.getValue() * (k1 + 1)) / (freq.getValue() + k1 * (1 - b
                + b * doclen / stats.avgdl)));
        }
