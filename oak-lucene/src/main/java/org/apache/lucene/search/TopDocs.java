...
/**
 * Represents hits returned by {@link IndexSearcher#search(Query, Filter, int)} and
...
public class TopDocs {
    ...
    private static class MergeSortQueue extends PriorityQueue<ShardRef> {
        ...
        public boolean lessThan(ShardRef first, ShardRef second) {
            ...
            for (int compIDX = 0; compIDX < comparators.length; compIDX++) {
                ...
                final int cmp = reverseMul[compIDX] * comp.compareValues(firstFD.fields[compIDX],
    ...
    /**
     * Returns a new TopDocs, containing topN results across the provided TopDocs, sorting by the
     * specified {@link Sort}.  Each of the TopDocs must have been sorted by the same Sort, and sort
     * field values must have been filled (ie, <code>fillFields=true</code> must be passed to
