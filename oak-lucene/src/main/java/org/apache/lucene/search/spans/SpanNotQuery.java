...
/**
 * Removes matches which overlap with another SpanQuery or within a x tokens before or y tokens
 * after another SpanQuery.
 */
public class SpanNotQuery extends SpanQuery implements Cloneable {
    ...
    /**
     * Construct a SpanNotQuery matching spans from <code>include</code> which have no overlap with
     * spans from <code>exclude</code> within
    ...
    public SpanNotQuery(SpanQuery include, SpanQuery exclude, int pre, int post) {
        ...
        if (include.getField() != null && exclude.getField() != null && !include.getField().equals(
            exclude.getField())) {
