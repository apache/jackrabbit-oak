 ...
 * using a TermRangeQuery with {@link DocTermOrdsRewriteMethod}: it will only do two ordinal to term
 * lookups.</p>
 */
...
public abstract class DocTermOrdsRangeFilter extends Filter {
    ...
    private DocTermOrdsRangeFilter(String field, BytesRef lowerVal, BytesRef upperVal,
     ...
     */
    public static DocTermOrdsRangeFilter newBytesRefRange(String field, BytesRef lowerVal,
        ...
        return new DocTermOrdsRangeFilter(field, lowerVal, upperVal, includeLower, includeUpper) {
            ...
            public DocIdSet getDocIdSet(AtomicReaderContext context, Bits acceptDocs)
                throws IOException {
                final SortedSetDocValues docTermOrds = FieldCache.DEFAULT.getDocTermOrds(
