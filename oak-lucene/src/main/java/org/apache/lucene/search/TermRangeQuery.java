 ...
 * ranges; use {@link NumericRangeQuery} instead.
 *
...
public class TermRangeQuery extends MultiTermQuery {
    ...
    /**
     * Constructs a query selecting all terms greater/equal than <code>lowerTerm</code> but
     * less/equal than <code>upperTerm</code>.
     *
     * <p>
    ...
    public String toString(String field) {
        ...
        buffer.append(lowerTerm != null ? ("*".equals(Term.toString(lowerTerm)) ? "\\*"
            : Term.toString(lowerTerm)) : "*");
        buffer.append(" TO ");
        buffer.append(upperTerm != null ? ("*".equals(Term.toString(upperTerm)) ? "\\*"
