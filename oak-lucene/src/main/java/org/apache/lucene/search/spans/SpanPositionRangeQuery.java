 ...
 *
 * @see org.apache.lucene.search.spans.SpanFirstQuery for a derivation that is optimized for the
 * case where start position is 0
 */
public class SpanPositionRangeQuery extends SpanPositionCheckQuery {
    ...
    public SpanPositionRangeQuery clone() {
        SpanPositionRangeQuery result = new SpanPositionRangeQuery((SpanQuery) match.clone(), start,
            end);
