 ...
 * supplied range according to {@link Byte#compareTo(Byte)},  It is not intended for numerical
 * ranges; use {@link NumericRangeFilter} instead.
 *
...
public class TermRangeFilter extends MultiTermQueryWrapperFilter<TermRangeQuery> {
     ...
     * @throws IllegalArgumentException if both terms are null or if lowerTerm is null and
     *                                  includeLower is true (similar for upperTerm and
     *                                  includeUpper)
     */
     ...
     */
    public static TermRangeFilter newStringRange(String field, String lowerTerm, String upperTerm,
        boolean includeLower, boolean includeUpper) {
    ...
    /**
     * Constructs a filter for field <code>fieldName</code> matching less than or equal to
     * <code>upperTerm</code>.
     */
    ...
    /**
     * Constructs a filter for field <code>fieldName</code> matching greater than or equal to
     * <code>lowerTerm</code>.
     */
