 ...
 * <p>
 * See {@link MultiLevelSkipListWriter} for the information about the encoding of the multi level
 * skip lists.
 * <p>
 * Subclasses must implement the abstract method {@link #readSkipData(int, IndexInput)} which
...
public abstract class MultiLevelSkipListReader implements Closeable {
    ...
    /**
     * Creates a {@code MultiLevelSkipListReader}, where {@code skipInterval} and
     * {@code skipMultiplier} are the same.
     */
    protected MultiLevelSkipListReader(IndexInput skipStream, int maxSkipLevels, int skipInterval) {
    ...
    /**
     * Skips entries to the first beyond the current whose document number is greater than or equal
     * to <i>target</i>. Returns the current doc count.
     */
