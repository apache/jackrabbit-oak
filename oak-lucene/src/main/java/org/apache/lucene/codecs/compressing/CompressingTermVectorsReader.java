...
public final class CompressingTermVectorsReader extends TermVectorsReader implements Closeable {
    ...
    private CompressingTermVectorsReader(CompressingTermVectorsReader reader) {
        ...
        this.reader = new BlockPackedReaderIterator(vectorsStream, packedIntsVersion, BLOCK_SIZE,
            0);
        this.closed = false;
    }
    ...
    public CompressingTermVectorsReader(Directory d, SegmentInfo si, String segmentSuffix,
        ...
        try {
            ...
            final String vectorsStreamFN = IndexFileNames.segmentFileName(segment, segmentSuffix,
                VECTORS_EXTENSION);
    ...
    public Fields get(int doc) throws IOException {
        ...
        if (doc < docBase || doc >= docBase + chunkDocs || docBase + chunkDocs > numDocs) {
            throw new CorruptIndexException(
                "docBase=" + docBase + ",chunkDocs=" + chunkDocs + ",doc=" + doc + " (resource="
                    + vectorsStream + ")");
        }
        ...
        final int[] fieldNums;
        {
            ...
            assert token
                != 0; // means no term vectors, cannot happen since we checked for numFields == 0
            ...
            final PackedInts.ReaderIterator it = PackedInts.getReaderIteratorNoHeader(vectorsStream,
                PackedInts.Format.PACKED, packedIntsVersion, totalDistinctFields, bitsPerFieldNum,
                1);
        ...
        final PackedInts.Reader flags;
        {
            ...
            switch (vectorsStream.readVInt()) {
                case 0:
                    ...
                    PackedInts.Mutable f = PackedInts.getMutable(totalFields, FLAGS_BITS,
                        PackedInts.COMPACT);
        ...
        decompressor.decompress(vectorsStream, totalLen + totalPayloadLength, docOff + payloadOff,
            docLen + payloadLen, suffixBytes);
        suffixBytes.length = docLen;
        final BytesRef payloadBytes = new BytesRef(suffixBytes.bytes, suffixBytes.offset + docLen,
            payloadLen);
    ...
    private int[][] positionIndex(int skip, int numFields, PackedInts.Reader numTerms,
        int[] termFreqs) {
    ...
    private int[][] readPositions(int skip, int numFields, PackedInts.Reader flags,
        PackedInts.Reader numTerms, int[] termFreqs, int flag, final int totalPositions,
        int[][] positionIndex) throws IOException {
    ...
    private class TVFields extends Fields {
        ...
        public TVFields(int[] fieldNums, int[] fieldFlags, int[] fieldNumOffs, int[] numTerms,
            int[] fieldLengths,
    ...
    private class TVTerms extends Terms {
        ...
        public TermsEnum iterator(TermsEnum reuse) throws IOException {
            ...
            termsEnum.reset(numTerms, flags, prefixLengths, suffixLengths, termFreqs, positionIndex,
    ...
    private static class TVTermsEnum extends TermsEnum {
        ...
        void reset(int numTerms, int flags, int[] prefixLengths, int[] suffixLengths,
            int[] termFreqs, int[] positionIndex, int[] positions, int[] startOffsets,
            int[] lengths,
        ...
        public final DocsEnum docs(Bits liveDocs, DocsEnum reuse, int flags) throws IOException {
            ...
            docsEnum.reset(liveDocs, termFreqs[ord], positionIndex[ord], positions, startOffsets,
