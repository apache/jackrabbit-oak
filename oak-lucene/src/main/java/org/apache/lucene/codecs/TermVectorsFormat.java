...
public abstract class TermVectorsFormat {
     ...
     */
    public abstract TermVectorsReader vectorsReader(Directory directory, SegmentInfo segmentInfo,
        FieldInfos fieldInfos, IOContext context) throws IOException;

    /**
     * Returns a {@link TermVectorsWriter} to write term vectors.
     */
    public abstract TermVectorsWriter vectorsWriter(Directory directory, SegmentInfo segmentInfo,
