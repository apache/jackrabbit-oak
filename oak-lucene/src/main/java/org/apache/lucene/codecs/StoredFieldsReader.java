 ...
 * <p>
 * You need to implement {@link #visitDocument(int, StoredFieldVisitor)} to read the stored fields
 * for a document, implement {@link #clone()} (creating clones of any IndexInputs used, etc), and
 * {@link #close()}
 *
 * @lucene.experimental
 */
