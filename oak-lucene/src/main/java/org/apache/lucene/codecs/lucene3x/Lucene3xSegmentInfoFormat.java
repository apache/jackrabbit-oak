...
public class Lucene3xSegmentInfoFormat extends SegmentInfoFormat {
    ...
    /**
     * This format adds optional per-segment String diagnostics storage, and switches userData to
     * Map
     */
    ...
    public static final String DS_OFFSET_KEY =
        Lucene3xSegmentInfoFormat.class.getSimpleName() + ".dsoffset";
    public static final String DS_NAME_KEY =
        Lucene3xSegmentInfoFormat.class.getSimpleName() + ".dsname";
    public static final String DS_COMPOUND_KEY =
        Lucene3xSegmentInfoFormat.class.getSimpleName() + ".dscompound";
    public static final String NORMGEN_KEY =
        Lucene3xSegmentInfoFormat.class.getSimpleName() + ".normgen";
    public static final String NORMGEN_PREFIX =
        Lucene3xSegmentInfoFormat.class.getSimpleName() + ".normfield";

    /**
     * @return if this segment shares stored fields & vectors, this offset is where in that file
     * this segment's docs begin
     */
