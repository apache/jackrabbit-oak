 ...
 * <p>
 * |       block#0       | |      block#1        | |vInts| d d d d d d d d d d d d d d d d d d d d d
 * d d d d d d d (posting list) ^                       ^       (level 0 skip point)
 * <p>
...
final class Lucene41SkipWriter extends MultiLevelSkipListWriter {
    ...
    public Lucene41SkipWriter(int maxSkipLevels, int blockSize, int docCount, IndexOutput docOut,
     ...
     */
    public void bufferSkip(int doc, int numDocs, long posFP, long payFP, int posBufferUpto,
        int payloadByteUpto) throws IOException {
        this.curDoc = doc;
