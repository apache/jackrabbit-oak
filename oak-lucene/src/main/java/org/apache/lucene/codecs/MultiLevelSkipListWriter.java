...
public abstract class MultiLevelSkipListWriter {
     ...
     */
    protected MultiLevelSkipListWriter(int skipInterval, int skipMultiplier, int maxSkipLevels,
        int df) {
    ...
    /**
     * Creates a {@code MultiLevelSkipListWriter}, where {@code skipInterval} and
    ...
    /**
     * Writes the current skip data to the buffers. The current document frequency determines the
     * max level is skip data is to be written to.
     *
