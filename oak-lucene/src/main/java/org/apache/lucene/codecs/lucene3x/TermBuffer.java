...
final class TermBuffer implements Cloneable {
    ...
    public void read(IndexInput input, FieldInfos fieldInfos)
        ...
        assert
            totalLength <= BYTE_BLOCK_SIZE - 2 : "termLength=" + totalLength + ",resource=" + input;
        ...
        if (fieldNumber != currentFieldNumber) {
            ...
            assert field.equals(fieldInfos.fieldInfo(fieldNumber).name) :
                "currentFieldNumber=" + currentFieldNumber + " field=" + field + " vs "
                    + fieldInfos.fieldInfo(fieldNumber) == null ? "null"
                    : fieldInfos.fieldInfo(fieldNumber).name;
        }
    }
