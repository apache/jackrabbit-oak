...
public abstract class Decompressor implements Cloneable {
     ...
     * stream <code>in</code> to <code>bytes</code>. After returning, the length of
     * <code>bytes</code> (<code>bytes.length</code>) must be equal to
     ...
     */
    public abstract void decompress(DataInput in, int originalLength, int offset, int length,
