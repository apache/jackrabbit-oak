...
class Lucene42DocValuesProducer extends DocValuesProducer {
    ...
    Lucene42DocValuesProducer(SegmentReadState state, String dataCodec, String dataExtension,
    ...
    private void readFields(IndexInput meta, FieldInfos infos) throws IOException {
        ...
        while (fieldNumber != -1) {
            ...
            if (fieldType == NUMBER) {
                ...
                throw new CorruptIndexException(
                    "invalid entry type: " + fieldType + ", input=" + meta);
            }
    ...
    private NumericDocValues loadNumeric(FieldInfo field) throws IOException {
        ...
        switch (entry.format) {
            case TABLE_COMPRESSED:
                ...
                final PackedInts.Reader ordsReader = PackedInts.getReaderNoHeader(data,
                    PackedInts.Format.byId(formatID), entry.packedIntsVersion, maxDoc,
                    bitsPerValue);
                ramBytesUsed.addAndGet(
                    RamUsageEstimator.sizeOf(decode) + ordsReader.ramBytesUsed());
    ...
    private BinaryDocValues loadBinary(FieldInfo field) throws IOException {
        ...
        if (entry.minLength == entry.maxLength) {
            ...
            final MonotonicBlockPackedReader addresses = new MonotonicBlockPackedReader(data,
        ...
        return new SortedDocValues() {
            ...
            public void lookupOrd(int ord, BytesRef result) {
                try {
                    ...
                    IntsRef output = Util.getByOutput(fst, ord, in, firstArc, scratchArc,
                        scratchInts);
    ...
    static class FSTTermsEnum extends TermsEnum {
        ...
        public void seekExact(long ord) throws IOException {
            ...
            fst.getFirstArc(firstArc);
            IntsRef output = Util.getByOutput(fst, ord, bytesReader, firstArc, scratchArc,
                scratchInts);
