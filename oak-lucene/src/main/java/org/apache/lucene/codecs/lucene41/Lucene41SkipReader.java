 ...
 * <p>
 * 0 1 2 3 4 5 d d d d d d    (posting list) ^     ^    (skip point in MultiLeveSkipWriter) ^ (skip
 * point in Lucene41SkipWriter)
 * <p>
 * In this case, MultiLevelSkipListReader will use the last document as a skip point, while
 * Lucene41SkipReader should assume no skip point will comes.
 * <p>
 * If we use the interface directly in Lucene41SkipReader, it may silly try to read another skip
...
final class Lucene41SkipReader extends MultiLevelSkipListReader {
    ...
    public Lucene41SkipReader(IndexInput skipStream, int maxSkipLevels, int blockSize,
     ...
     * <p>
     * Since our definition in Lucene41Skip* is a little different from MultiLevelSkip* This trimmed
     * docFreq will prevent skipReader from: 1. silly reading a non-existed skip point after the
     * last block boundary 2. moving into the vInt block
     */
