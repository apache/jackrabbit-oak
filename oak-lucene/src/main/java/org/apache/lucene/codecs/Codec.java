 ...
 * for the segment to be read, the name must resolve to your implementation via
...
public abstract class Codec implements NamedSPILoader.NamedSPI {
     ...
     * read this class should be registered with Java's SPI mechanism (registered in META-INF/ of
     * your jar file, etc).
     *
    ...
    /**
     * returns the codec's name. Subclasses can override to provide more detail (such as
     * parameters).
     */
    @Override
