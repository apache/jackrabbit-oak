...
public abstract class StoredFieldsFormat {
     ...
     */
    public abstract StoredFieldsReader fieldsReader(Directory directory, SegmentInfo si,
        FieldInfos fn, IOContext context) throws IOException;

    /**
     * Returns a {@link StoredFieldsWriter} to write stored fields.
     */
    public abstract StoredFieldsWriter fieldsWriter(Directory directory, SegmentInfo si,
