...
public abstract class DocValuesFormat implements NamedSPILoader.NamedSPI {
     ...
     * using {@code PerFieldDocValuesFormat}): in such configurations, for the segment to be read
    ...
    /**
     * Reloads the DocValues format list from the given {@link ClassLoader}. Changes to the
     * docvalues formats are visible after the method ends, all iterators
     * ({@link #availableDocValuesFormats()},...) stay consistent.
     *
