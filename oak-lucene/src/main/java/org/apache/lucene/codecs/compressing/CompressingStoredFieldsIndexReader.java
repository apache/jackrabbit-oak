...
public final class CompressingStoredFieldsIndexReader implements Cloneable {
    ...
    // has been called
    CompressingStoredFieldsIndexReader(IndexInput fieldsIndexIn, SegmentInfo si)
        throws IOException {
        ...
        for (; ; ) {
            ...
            if (bitsPerDocBase > 32) {
                throw new CorruptIndexException(
                    "Corrupted bitsPerDocBase (resource=" + fieldsIndexIn + ")");
            }
            docBasesDeltas[blockCount] = PackedInts.getReaderNoHeader(fieldsIndexIn,
            ...
            if (bitsPerStartPointer > 64) {
                throw new CorruptIndexException(
                    "Corrupted bitsPerStartPointer (resource=" + fieldsIndexIn + ")");
            }
            startPointersDeltas[blockCount] = PackedInts.getReaderNoHeader(fieldsIndexIn,
