...
public abstract class DocValuesProducer implements Closeable {
    ...
    /**
     * Returns {@link NumericDocValues} for this field. The returned instance need not be
    ...
    /**
     * Returns {@link BinaryDocValues} for this field. The returned instance need not be
     * thread-safe: it will only be used by a single thread.
     */
    public abstract BinaryDocValues getBinary(FieldInfo field) throws IOException;

    /**
     * Returns {@link SortedDocValues} for this field. The returned instance need not be
     * thread-safe: it will only be used by a single thread.
     */
     ...
     * each docid that does have a value for this field. The returned instance need not be
     * thread-safe: it will only be used by a single thread.
     */
    ...
    /**
     * A simple implementation of {@link DocValuesProducer#getDocsWithField} that returns
     * {@code true} if a document has an ordinal &gt;= 0
     * <p>
     * Codecs can choose to use this (or implement it more efficiently another way), but in most
     * cases a Bits is unnecessary anyway: users can check this as they go.
     */
    ...
    /**
     * A simple implementation of {@link DocValuesProducer#getDocsWithField} that returns
     * {@code true} if a document has any ordinals.
     * <p>
     * Codecs can choose to use this (or implement it more efficiently another way), but in most
     * cases a Bits is unnecessary anyway: users can check this as they go.
     */
