 ...
 * <p>
 * Encodes the four per-document value types (Numeric,Binary,Sorted,SortedSet) with seven basic
 * strategies.
 * <p>
 * <ul>
...
public class Lucene42DocValuesFormat extends DocValuesFormat {
    ...
    /**
     * Calls {@link #Lucene42DocValuesFormat(float) Lucene42DocValuesFormat(PackedInts.DEFAULT)}
     */
