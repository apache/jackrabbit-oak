...
/**
 * @lucene.experimental
 * @deprecated (4.0) No longer used with flex indexing, except for reading old segments
 */
...
final class SegmentTermEnum implements Cloneable, Closeable {
    ...
    SegmentTermEnum(IndexInput i, FieldInfos fis, boolean isi)
        ...
        if (firstInt >= 0) {
            ...
            assert
                indexInterval > 0 : "indexInterval=" + indexInterval + " is negative; must be > 0";
    ...
    /**
     * Returns the current Term in the enumeration. Initially invalid, valid after next() called for
     * the first time.
     */
    ...
    /**
     * Returns the current TermInfo in the enumeration. Initially invalid, valid after next() called
     * for the first time.
     */
    ...
    /**
     * Sets the argument to the current TermInfo in the enumeration. Initially invalid, valid after
    ...
    /**
     * Returns the docFreq from the current TermInfo in the enumeration. Initially invalid, valid
