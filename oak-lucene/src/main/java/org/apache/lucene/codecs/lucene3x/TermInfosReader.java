 ...
 *
 * @lucene.experimental
 * @deprecated (4.0) This class has been replaced by FormatPostingsTermsDictReader, except for
    ...
    TermInfosReader(Directory dir, String seg, FieldInfos fis, IOContext context, int indexDivisor)
        ...
        try {
            ...
            origEnum = new SegmentTermEnum(directory.openInput(
                IndexFileNames.segmentFileName(segment, "", Lucene3xPostingsFormat.TERMS_EXTENSION),
            ...
            if (indexDivisor != -1) {
                ...
                final String indexFileName = IndexFileNames.segmentFileName(segment, "",
                    Lucene3xPostingsFormat.TERMS_INDEX_EXTENSION);
                final SegmentTermEnum indexEnum = new SegmentTermEnum(
                    directory.openInput(indexFileName,
