...
public abstract class StoredFieldsWriter implements Closeable {
     ...
     * called even if the document has no stored fields, in this case <code>numStoredFields</code>
     * will be zero.
     */
     ...
     * returning the number of documents that were written. Implementations can override this method
     ...
     */
    protected final void addDocument(Iterable<? extends IndexableField> doc, FieldInfos fieldInfos)
        throws IOException {
        int storedCount = 0;
