...
public interface OffsetAttribute extends Attribute {
    ...
    /**
     * Returns this Token's starting offset, the position of the first character corresponding to
     * this token in the source text.
     * <p>
     * Note that the difference between {@link #endOffset()} and <code>startOffset()</code> may not
     ...
     *                                  negative, or if <code>startOffset</code> is greater than
     *                                  <code>endOffset</code>
     * @see #startOffset()
     * @see #endOffset()
     */
