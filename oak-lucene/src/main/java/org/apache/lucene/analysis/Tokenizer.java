...
public abstract class Tokenizer extends TokenStream {
    ...
    protected final int correctOffset(int currentOff) {
        return (input instanceof CharFilter) ? ((CharFilter) input).correctOffset(currentOff)
            : currentOff;
    }

    /**
     * Expert: Set a new reader on the Tokenizer.  Typically, an analyzer (in its tokenStream
