...
public interface TermToBytesRefAttribute extends Attribute {
    ...
    /**
     * Updates the bytes {@link #getBytesRef()} to contain this term's final encoding, and returns
     * its hashcode.
     *
     ...
     *  }
     * </pre>
     * Implement this for performance reasons, if your code can calculate the hash on-the-fly. If
     * this is not the case, just return {@code termBytes.hashCode()}.
     */
