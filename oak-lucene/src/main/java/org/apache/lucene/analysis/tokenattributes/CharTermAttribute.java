...
public interface CharTermAttribute extends Attribute, CharSequence, Appendable {
    ...
    /**
     * Returns the internal termBuffer character array which you can then directly alter.  If the
     * array is too small for your token, use {@link #resizeBuffer(int)} to increase it.  After
     * altering the buffer be sure to call {@link #setLength} to record the number of valid
    ...
    /**
     * Sets the length of the termBuffer to zero. Use this method before appending contents using
     * the {@link Appendable} interface.
     */
     ...
     * <p>The characters of the {@code String} argument are appended, in order, increasing the
     ...
     * <p>The characters of the {@code StringBuilder} argument are appended, in order, increasing
     ...
     * <p>The characters of the {@code CharTermAttribute} argument are appended, in order,
     * increasing the length of this sequence by the length of the argument. If argument is
     * {@code null}, then the four characters {@code "null"} are appended.
     */
