 ...
 * for indexing numeric values that can be used by {@link NumericRangeQuery} or
 * {@link NumericRangeFilter}.
 *
 * <p>Note that for simple usage, {@link IntField}, {@link
 * LongField}, {@link FloatField} or {@link DoubleField} is recommended.  These fields disable norms
 * and term freqs, as they are not usually needed during searching.  If you need to change these
 ...
 * it's more for iterating the different precisions during indexing a specific numeric value.</p>
 *
 * <p><b>NOTE</b>: as token streams are only consumed once
 * the document is added to the index, if you index more than one numeric field, use a separate
 * <code>NumericTokenStream</code> instance for each.</p>
 *
...
public final class NumericTokenStream extends TokenStream {
    ...
    public interface NumericTermAttribute extends Attribute {
        ...
        /**
         * Returns value size in bits (32 for {@code float}, {@code int}; 64 for {@code double},
         * {@code long})
         */
        int getValueSize();
     ...
     * @since 4.0
     */
    public static final class NumericTermAttributeImpl extends AttributeImpl implements
        NumericTermAttribute, TermToBytesRefAttribute {
     ...
     * {@link NumericUtils#PRECISION_STEP_DEFAULT} (4). The stream is not yet initialized, before
     * using set a value using the various set<em>???</em>Value() methods.
     */
     ...
     * {@link org.apache.lucene.util.AttributeSource.AttributeFactory}. The stream is not yet
