 ...
 * {@link java.io.Reader} with additional offset correction. {@link Tokenizer}s will automatically
 * use {@link #correctOffset} if a CharFilter subclass is used.
 * <p>
 ...
 * <p>
 * You can optionally provide more efficient implementations of additional methods like
 * {@link #read()}, {@link #read(char[])}, {@link #read(java.nio.CharBuffer)}, but this is not
 * required.
 * <p>
...
public abstract class CharFilter extends Reader {
     ...
     * <p>
     * <b>NOTE:</b>
     * The default implementation closes the input Reader, so be sure to call
     * <code>super.close()</code> when overriding this method.
     */
    @Override
    ...
    public final int correctOffset(int currentOff) {
        ...
        return (input instanceof CharFilter) ? ((CharFilter) input).correctOffset(corrected)
            : corrected;
    }
}
