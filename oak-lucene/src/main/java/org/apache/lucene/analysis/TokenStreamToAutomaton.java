...
public class TokenStreamToAutomaton {
    ...
    /**
     * Whether to generate holes in the automaton for missing positions, <code>true</code> by
     * default.
     */
    ...
    /**
     * Subclass & implement this if you need to change the token (such as escaping certain bytes)
    ...
    /**
     * Pulls the graph (including {@link PositionLengthAttribute}) from the provided
     * {@link TokenStream}, and creates the corresponding automaton where arcs are bytes (or Unicode
     * code points if unicodeArcs = true) from each term.
     */
    public Automaton toAutomaton(TokenStream in) throws IOException {
        ...
        final PositionIncrementAttribute posIncAtt = in.addAttribute(
        ...
        while (posData.arriving == null || prevPosData.leaving == null) {
            ...
            if (prevPosData.leaving == null) {
                ...
                if (prevPosData.arriving != null) {
                    prevPosData.arriving.addTransition(
                        new Transition(POS_SEP, prevPosData.leaving));
                }
            }
