...
public abstract class Analyzer implements Closeable {
    ...
    /**
     * Create a new Analyzer, reusing the same set of components per-thread across calls to
    ...
    /**
     * Returns a TokenStream suitable for <code>fieldName</code>, tokenizing the contents of
     * <code>reader</code>.
     * <p>
     * This method uses {@link #createComponents(String, Reader)} to obtain an instance of
     * {@link TokenStreamComponents}. It returns the sink of the components and stores the
     * components internally. Subsequent calls to this method will reuse the previously stored
     * components after resetting them through {@link TokenStreamComponents#setReader(Reader)}.
     * <p>
     * <b>NOTE:</b> After calling this method, the consumer must follow the
     * workflow described in {@link TokenStream} to properly consume its contents. See the
     * {@link org.apache.lucene.analysis Analysis package documentation} for some examples
     * demonstrating this.
     *
     * <b>NOTE:</b> If your data is available as a {@code String}, use
     * {@link #tokenStream(String, String)} which reuses a {@code StringReader}-like instance
     * internally.
     *
     ...
     * IndexbleField instances using the same field name.  The default value position increment gap
     * is 0.  With a 0 position increment gap and the typical default token position increment of 1,
     * all terms in a field, including across IndexableField instances, are in successive positions,
     ...
     * {@link #tokenStream(String, Reader)}. This value must be {@code >= 0}.
     */
    ...
    /**
     * Just like {@link #getPositionIncrementGap}, except for Token offsets instead.  By default
     * this returns 1. This method is only called if the field produced at least one token for
     * indexing.
     *
     ...
     * source ({@link Tokenizer}) and the outer end (sink), an instance of {@link TokenFilter} which
     * also serves as the {@link TokenStream} returned by
    ...
    public static class TokenStreamComponents {
        ...
        /**
         * Sink tokenstream, such as the outer tokenfilter decorating the chain. This can be the
        ...
        /**
         * Resets the encapsulated components with the given reader. If the components cannot be
         * reset, an Exception should be thrown.
         *
    ...
    public static abstract class ReuseStrategy {
         ...
         *                  {@link #getStoredValue(Analyzer)} and
         *                  {@link #setStoredValue(Analyzer, Object)} to access the data on the
         *                  Analyzer.
         * @param fieldName Name of the field whose reusable TokenStreamComponents are to be
         *                  retrieved
        ...
        /**
         * Stores the given TokenStreamComponents as the reusable components for the field with the
         * give name.
         *
    ...
    /**
     * Implementation of {@link ReuseStrategy} that reuses the same components for every field.
     *
     * @deprecated This implementation class will be hidden in Lucene 5.0. Use
     * {@link Analyzer#GLOBAL_REUSE_STRATEGY} instead!
     */
    @Deprecated
    ...
    /**
     * Implementation of {@link ReuseStrategy} that reuses components per-field by maintaining a Map
     * of TokenStreamComponent per field name.
     *
     * @deprecated This implementation class will be hidden in Lucene 5.0. Use
     * {@link Analyzer#PER_FIELD_REUSE_STRATEGY} instead!
     */
    @Deprecated
    public static class PerFieldReuseStrategy extends ReuseStrategy {
         ...
         *
         * @deprecated Don't create instances of this class, use
         * {@link Analyzer#PER_FIELD_REUSE_STRATEGY}
         */
        @Deprecated
