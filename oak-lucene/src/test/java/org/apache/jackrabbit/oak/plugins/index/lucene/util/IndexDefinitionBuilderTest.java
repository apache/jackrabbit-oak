...
import static org.apache.jackrabbit.oak.plugins.index.lucene.LuceneIndexConstants.PROP_FACETS;
import static org.apache.jackrabbit.oak.plugins.index.lucene.LuceneIndexConstants.PROP_REFRESH_DEFN;
import static org.apache.jackrabbit.oak.plugins.index.lucene.LuceneIndexConstants.COST_PER_ENTRY;
import static org.apache.jackrabbit.oak.plugins.index.lucene.LuceneIndexConstants.COST_PER_EXECUTION;
...
public class IndexDefinitionBuilderTest {
    ...
    public void noReindexWhenFacetConfigChanged_topChildren() throws Exception {
        ...
        builder.getBuilderTree().getChild(PROP_FACETS).setProperty(LuceneIndexConstants.PROP_FACETS_TOP_CHILDREN,100);
        currentNodeState = builder.build();
        ...
        builder.getBuilderTree().getChild(PROP_FACETS).setProperty(LuceneIndexConstants.PROP_FACETS_TOP_CHILDREN,200);
        currentNodeState = builder.build();
        assertFalse(currentNodeState.getBoolean(REINDEX_PROPERTY_NAME));
        assertTrue(currentNodeState.getBoolean(PROP_REFRESH_DEFN));
        ...
        nodeBuilder.removeProperty(PROP_REFRESH_DEFN);
        builder = new IndexDefinitionBuilder(nodeBuilder);
        builder.getBuilderTree().getChild(PROP_FACETS).removeProperty(LuceneIndexConstants.PROP_FACETS_TOP_CHILDREN);
        currentNodeState = builder.build();
    ...
    public void noReindexWhenFacetConfigChanged_secure() throws Exception {
        ...
        builder.getBuilderTree().getChild(PROP_FACETS).setProperty(LuceneIndexConstants.PROP_SECURE_FACETS,LuceneIndexConstants.PROP_SECURE_FACETS_VALUE_SECURE);
        currentNodeState = builder.build();
        assertFalse(currentNodeState.getBoolean(REINDEX_PROPERTY_NAME));
        assertTrue(currentNodeState.getBoolean(PROP_REFRESH_DEFN));
        nodeBuilder = currentNodeState.builder();
        ...
        builder.getBuilderTree().getChild(PROP_FACETS).setProperty(LuceneIndexConstants.PROP_SECURE_FACETS,LuceneIndexConstants.PROP_SECURE_FACETS_VALUE_INSECURE);
        currentNodeState = builder.build();
        assertFalse(currentNodeState.getBoolean(REINDEX_PROPERTY_NAME));
        assertTrue(currentNodeState.getBoolean(PROP_REFRESH_DEFN));
        //Now check for property delete use case
        ...
        nodeBuilder.removeProperty(PROP_REFRESH_DEFN);
        builder = new IndexDefinitionBuilder(nodeBuilder);
        builder.getBuilderTree().getChild(PROP_FACETS).removeProperty(LuceneIndexConstants.PROP_SECURE_FACETS);
        currentNodeState = builder.build();
    ...
    public void noReindexWhenFacetConfigChanged_sampleSize() throws Exception {
        ...
        builder.getBuilderTree().getChild(PROP_FACETS).setProperty(LuceneIndexConstants.PROP_STATISTICAL_FACET_SAMPLE_SIZE,1000);
        currentNodeState = builder.build();
        assertTrue(currentNodeState.getBoolean(PROP_REFRESH_DEFN));
        assertFalse(currentNodeState.getBoolean(REINDEX_PROPERTY_NAME));
        nodeBuilder = currentNodeState.builder();
        ...
        builder.getBuilderTree().getChild(PROP_FACETS).setProperty(LuceneIndexConstants.PROP_STATISTICAL_FACET_SAMPLE_SIZE,2000);
        currentNodeState = builder.build();
        assertFalse(currentNodeState.getBoolean(REINDEX_PROPERTY_NAME));
        assertTrue(currentNodeState.getBoolean(PROP_REFRESH_DEFN));
        //Now check for property delete use case
        ...
        nodeBuilder.removeProperty(PROP_REFRESH_DEFN);
        builder = new IndexDefinitionBuilder(nodeBuilder);
        builder.getBuilderTree().getChild(PROP_FACETS).removeProperty(LuceneIndexConstants.PROP_STATISTICAL_FACET_SAMPLE_SIZE);
        currentNodeState = builder.build();
    ...
    public void renidexIfFacetsNodeAddedwithSomeNewPropThatReqIndexing() throws Exception {
        ...
        //Add foo prop on facets node
        builder.getBuilderTree().getChild(PROP_FACETS).setProperty("foo","bar");
        builder.getBuilderTree().getChild(PROP_FACETS).setProperty(LuceneIndexConstants.PROP_STATISTICAL_FACET_SAMPLE_SIZE,200);
