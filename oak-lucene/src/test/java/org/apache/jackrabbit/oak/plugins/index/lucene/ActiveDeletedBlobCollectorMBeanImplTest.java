...
public class ActiveDeletedBlobCollectorMBeanImplTest {
    ...
    public void onlyRunningIndexesRequireToBeWaitedOn() {
        ...
        AsyncIndexInfoService asyncIndexInfoService = MockRegistrar.getAsyncIndexInfoService(NAL(
        ...
        statusSupplier.status = STATUS_RUNNING;
        asyncIndexInfoService = MockRegistrar.getAsyncIndexInfoService(NAL(
