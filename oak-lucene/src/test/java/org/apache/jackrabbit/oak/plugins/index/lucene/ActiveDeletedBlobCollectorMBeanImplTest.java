...
public class ActiveDeletedBlobCollectorMBeanImplTest {
    ...
    public void onlyRunningIndexesRequireToBeWaitedOn() {
        ...
        AsyncIndexInfoService asyncIndexInfoService = MockRegistrar.getAsyncIndexInfoService(new ArrayList<>(
        ...
        statusSupplier.status = STATUS_RUNNING;
        asyncIndexInfoService = MockRegistrar.getAsyncIndexInfoService(new ArrayList<>(
