 ...
 */
public class AzureDataRecordAccessProviderV12IT extends AbstractDataRecordAccessProviderIT {

    private static final Logger log = LoggerFactory.getLogger(AzureDataRecordAccessProviderV12IT.class);
    ...
    private static boolean isAzureConfigured() {
    ...
    private static Properties getAzureConfig() {
    ...
    private static DataStore getAzureDataStore(Properties props, String homeDir) throws Exception {
