...
public class DefaultSasTokenGenerator implements SasTokenGenerator {
    @Override
    @NotNull
    public String generateSharedAccessSignature(
        ...
        if (null == optionalHeaders) {
            return blob.generateSharedAccessSignature(policy, null);
        }
        return blob.generateSharedAccessSignature(policy, optionalHeaders, null, null, null, true);
    }
}
