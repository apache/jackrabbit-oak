...
public class ElasticIndexQueryCommonTest extends IndexQueryCommonTest {
    ...
    public void similarityQueryShouldCorrectlyHandleSimilarityTags() throws CommitFailedException {
        ...
        assertEventually(
            getAssertionForExplain(query, Query.JCR_SQL2, explainWithoutSimilarityTags, false));
        ...
        Tree properties = indexDefn.getChild(FulltextIndexConstants.INDEX_RULES).getChild("nt:base")
                                   .getChild("properties");
        ...
        assertEventually(
            getAssertionForExplain(query, Query.JCR_SQL2, explainWithSimilarityTags, false));
    }
