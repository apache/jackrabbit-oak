...
public class ElasticIndexPlannerCommonTest extends IndexPlannerCommonTest {
    ...
    public ElasticIndexPlannerCommonTest() {
        ...
        this.hook = new EditorHook(new IndexUpdateProvider(
            new ElasticIndexEditorProvider(indexTracker, esConnection, null)));
    }
    ...
    public void after() throws IOException {
        if (esConnection != null) {
            try {
                esConnection.getClient().indices()
                            .delete(d -> d.index(esConnection.getIndexPrefix() + "*"));
            } catch (IOException e) {
    ...
    protected IndexNode createIndexNode(IndexDefinition defn) throws IOException {
        ...
        return new ElasticIndexNodeManager(defn.getIndexPath(), builder.getNodeState(),
            esConnection).getIndexNode();
    }
    ...
    protected NodeBuilder getPropertyIndexDefinitionNodeBuilder(@NotNull NodeBuilder builder,
        ...
        defBuilder.setProperty(
            createProperty(FulltextIndexConstants.INCLUDE_PROPERTY_NAMES, includes, STRINGS));
    ...
    protected NodeBuilder getIndexDefinitionNodeBuilder(@NotNull NodeBuilder index,
        ...
        if (propertyTypes != null && !propertyTypes.isEmpty()) {
            indexDefBuilder.setProperty(
                createProperty(FulltextIndexConstants.INCLUDE_PROPERTY_TYPES,
