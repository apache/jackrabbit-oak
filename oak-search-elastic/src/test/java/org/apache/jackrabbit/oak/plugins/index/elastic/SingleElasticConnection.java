...
public class SingleElasticConnection {

    private static final Logger LOG = LoggerFactory.getLogger(SingleElasticConnection.class);
    ...
    public SingleElasticConnection(String elasticConnectionString) {
        this.elasticConnectionString = elasticConnectionString;
    }
    
    public static void main(String[] args) {
        SingleElasticConnection conn = new SingleElasticConnection(null);
        conn.apply();
        try {
            System.in.read();
            conn.stop();
    ...
    private void setUseDocker(boolean useDocker) {
        SingleElasticConnection.useDocker = useDocker;
    }
