...
public class InferenceServiceManager {
    ...
    private  static  final InferenceServiceMetrics uncachedServiceMetrics = new InferenceServiceMetrics("UNCACHED_SERVICE", UNCACHED_SERVICE_CACHE_SIZE);
    ...
    public static InferenceService getInstance(@NotNull String url, String model) {
        ...
        return SERVICES.computeIfAbsent(k, key -> new InferenceServiceUsingIndexConfig(url, CACHE_SIZE, new InferenceServiceMetrics(k, CACHE_SIZE)));
    }
    ...
    public static InferenceService getInstance(InferenceModelConfig inferenceModelConfig) {
        ...
        return SERVICES.computeIfAbsent(key, k -> new InferenceServiceUsingConfig(inferenceModelConfig, new InferenceServiceMetrics(k, inferenceModelConfig.getCacheSize())));
    }
}
