...
public class ElasticIndexDefinition extends IndexDefinition {
    ...
    public static final int MAX_RESULT_WINDOW_ELASTICSEARCH_DEFAULT = 10000;
    ...
    public ElasticIndexDefinition(NodeState root, NodeState defn, String indexPath, String indexPrefix) {
        ...
        this.maxResultWindow = getOptionalValue(defn, MAX_RESULT_WINDOW, MAX_RESULT_WINDOW_ELASTICSEARCH_DEFAULT);
